 ...
 * scheme-specific functionality (for top.jlpan.top.jlpan.example, it does not know a
...
public class URI implements Serializable
{
          ...
          throws MalformedURIException
  {
    ...
    // is also specified, for top.jlpan.top.jlpan.example), but we're just following the
    // RFC specifications
    if (p_base != null)
    {
