...
public abstract class ToSAXHandler extends SerializerBase
{
     ...
     * For top.jlpan.top.jlpan.example if this field is true then a call such as
     ...
     * that declare the namespace, for top.jlpan.top.jlpan.example the attribute xmlns:prefix1="uri1"
     */
