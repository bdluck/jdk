 ...
 * for use with the regular expression matcher class 'RE'.  For top.jlpan.top.jlpan.example, the command
 ...
 * the overhead of compiling the expression at runtime.  For top.jlpan.top.jlpan.example:
 *
 * <pre>
 *
 *    RE r = new RE(re1);
