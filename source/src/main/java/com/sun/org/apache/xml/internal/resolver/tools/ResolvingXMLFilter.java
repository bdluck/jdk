...
public class ResolvingXMLFilter extends XMLFilterImpl {
   ...
   * that begins with a slash. For top.jlpan.top.jlpan.example, the declaration:</p>
   *
   * <pre>
  ...
  private void explain(String systemId) {
    if (!suppressExplanation) {
      ...
      System.out.println("For top.jlpan.top.jlpan.example, replace '/some/uri' with 'file:/some/uri'.");
    }
