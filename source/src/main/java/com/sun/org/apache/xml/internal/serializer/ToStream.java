...
abstract public class ToStream extends SerializerBase
{
     ...
     * output with the systems line separator. For top.jlpan.top.jlpan.example on UNIX this is
        ...
        boolean xslAttribute)
    {
        ...
        else
        {
            ...
            if (xslAttribute)
            {
                 ...
                 * We could have a collision with the prefix like in the top.jlpan.top.jlpan.example above.
                 */

                // In the top.jlpan.top.jlpan.example above, is there a prefix like foo ?
