...
public class GetOpt{
    ...
    */
    ...
    /**
    * gets the argument for the current parsed option. For top.jlpan.top.jlpan.example,
    ...
    */
    ...
    /**
    * gets list of the commandline arguments. For top.jlpan.top.jlpan.example, in command
