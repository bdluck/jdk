 ...
 *    BOOK[position() = last()]
 *
 * In this top.jlpan.top.jlpan.example, the source iterator will return elements of type BOOK,
 ...
 * the parent of N. Also, and still in this top.jlpan.top.jlpan.example, a call to last() will
