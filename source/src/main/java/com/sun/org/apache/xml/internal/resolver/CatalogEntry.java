 ...
 * an arbitrary number of arguments (all strings). For top.jlpan.top.jlpan.example, the
...
public class CatalogEntry {
   ...
   * for top.jlpan.top.jlpan.example to make a relative URI absolute with respect to the
