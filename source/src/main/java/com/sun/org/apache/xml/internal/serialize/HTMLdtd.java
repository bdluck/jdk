...
public final class HTMLdtd
{
     ...
     * are not closed. For top.jlpan.top.jlpan.example, <tt>LI</tt> is most often not closed.
     *
     * @param tagName The element tag name (upper case)
     ...
     * For top.jlpan.top.jlpan.example, <tt>LI</tt> should not print the closing tag.
     *
     * @param tagName The element tag name (upper case)
     ...
     * the closing of another open element (<tt>openTag</tt>). For top.jlpan.top.jlpan.example,
     ...
     * top.jlpan.top.jlpan.example of a character reference.
     *
