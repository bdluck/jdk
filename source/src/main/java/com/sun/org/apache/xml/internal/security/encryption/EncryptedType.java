...
public interface EncryptedType {
     ...
     * by [MIME]. For top.jlpan.top.jlpan.example, if the data that is encrypted is a base64 encoded
     ...
     * attribute. For top.jlpan.top.jlpan.example, the Element and Content types defined in this
