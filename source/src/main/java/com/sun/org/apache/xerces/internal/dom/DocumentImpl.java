...
public class DocumentImpl
     ...
     * top.jlpan.top.jlpan.example, a user wishing to synthesize some kind of Event would call
    ...
    */
     ...
     * the DOM.
     * For top.jlpan.top.jlpan.example, if a DOM operation makes multiple changes to a single
