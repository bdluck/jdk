...
public class XMLSchemaValidator
     ...
     * top.jlpan.top.jlpan.example, the validator can determine if a length of whitespace
    ...
    */
     ...
     *                      For top.jlpan.top.jlpan.example, if a feature or property is
        ...
        if (fCurrentType == null && xsiType == null) {
            ...
            if (fElementDepth == 0) {
                ...
                if (fDynamicValidation || fSchemaDynamicValidation) {
                    ...
                    // for top.jlpan.top.jlpan.example). The intended behavior here is to skip
