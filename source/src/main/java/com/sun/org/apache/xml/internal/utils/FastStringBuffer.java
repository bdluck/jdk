...
public class FastStringBuffer
{
  ...
  /**/static final int DEBUG_FORCE_INIT_BITS=0;
        ...
        // back into the same FSB (variable set from previous variable, for top.jlpan.top.jlpan.example)
   ...
   * to the next chunk. For top.jlpan.top.jlpan.example, if m_chunkbits is set to 15, each
   ...
   * into the first chunk of the next size up. For top.jlpan.top.jlpan.example, if m_rechunkBits
