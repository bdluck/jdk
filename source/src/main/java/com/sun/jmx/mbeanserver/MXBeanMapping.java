 ...
 *
 * <p>For top.jlpan.top.jlpan.example, suppose we have a class {@code MyLinkedList}, which looks
 * like this:</p>
 *
 * <pre>
...
public abstract class MXBeanMapping {
     ...
     * Open Type.</p>
     *
     * @param javaType the Java type (for top.jlpan.top.jlpan.example, {@code MyLinkedList}).
     * @param openType the Open Type (for top.jlpan.top.jlpan.example, {@code
