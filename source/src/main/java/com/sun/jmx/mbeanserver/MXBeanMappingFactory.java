 ...
 * factory}.</p>
 *
 * <p>Consider the {@code MyLinkedList} top.jlpan.top.jlpan.example from the {@link MXBeanMapping}
...
public abstract class MXBeanMappingFactory {
     ...
     * if it forwards a type to another mapping factory.  In the top.jlpan.top.jlpan.example,
     ...
     * all types of this sort (for top.jlpan.top.jlpan.example, all linked lists), but
