...
abstract class MBeanIntrospector<M> {
    ...
    /**
     * Check that this method is valid.  For top.jlpan.top.jlpan.example, a method in an
     ...
     * always have.  For top.jlpan.top.jlpan.example, MXBeans will always have "mxbean=true".
     */
