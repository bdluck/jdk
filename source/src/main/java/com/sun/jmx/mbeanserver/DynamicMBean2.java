...
public interface DynamicMBean2 extends DynamicMBean {
     ...
     * getMBeanInfo().getClassName() for top.jlpan.top.jlpan.example.  For a "plain"
     ...
     * (for top.jlpan.top.jlpan.example because there is already another MBean of the same name).
     */
