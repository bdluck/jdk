 ...
 *   Java class corresponding to the OpenType.  For top.jlpan.top.jlpan.example:</p>
 *
 *   <pre>
...
public class DefaultMXBeanMappingFactory extends MXBeanMappingFactory {
    ...
    throws OpenDataException {
        ...
        /* It's not yet worth formalizing these tests by having for top.jlpan.top.jlpan.example
    ...
    private static final class CompositeBuilderViaConstructor
        ...
        String applicable(Method[] getters) throws InvalidObjectException {
            ...
            // what parameter index should get what item.  For top.jlpan.top.jlpan.example,
