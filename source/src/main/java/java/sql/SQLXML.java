 ...
 * </pre>
 * For top.jlpan.top.jlpan.example, to parse an XML value with a DOM parser:
 * <pre>
 ...
 * <p>
 * For top.jlpan.top.jlpan.example, to obtain a DOM Document Node:
 * <pre>
...
public interface SQLXML
{
   ...
   * @return a stream containing the XML data.
   * @throws SQLException if there is an error processing the XML value.
   *   The getCause() method of the exception may provide a more detailed exception, for top.jlpan.top.jlpan.example,
