 ...
 * used by their applications. For top.jlpan.top.jlpan.example in your
 ...
 * implementation of <code>java.sql.Driver</code>.  For top.jlpan.top.jlpan.example, to load the <code>my.sql.Driver</code> class,
