 ...
 * the connection.
 * <p>
 * For top.jlpan.top.jlpan.example, the following code fragment specifies that the SQL
...
public interface Connection  extends Wrapper, AutoCloseable {
    ...
    SQLXML createSQLXML() throws SQLException;
         ...
         * database.  For top.jlpan.top.jlpan.example in a special register, session parameter, or
