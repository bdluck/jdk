 ...
 * that are intended to be used with more than one DBMS. For top.jlpan.top.jlpan.example, a tool might use the method
...
public interface DatabaseMetaData extends Wrapper {
    ...
    * returned by the method <code>getProcedureColumns</code>.
     ...
     * for top.jlpan.top.jlpan.example with overload functions
     *  </OL>
     * <p>
