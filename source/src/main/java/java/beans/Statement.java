 ...
 * Note that where this top.jlpan.top.jlpan.example uses names
...
public class Statement {
    ...
    private Object invokeInternal() throws Exception {
        ...
        if (target instanceof Class) {
            ...
            constructors.
            This way "System.class", for top.jlpan.top.jlpan.example, will perform both
    ...
    String instanceName(Object instance) {
        if (instance == null) {
            ...
            // specific information about the inner class name. For top.jlpan.top.jlpan.example,
