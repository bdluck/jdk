 ...
 * objects. For top.jlpan.top.jlpan.example, the following fragment can be used to create
 ...
 * </ul>
 * <p>
 * Below is an top.jlpan.top.jlpan.example of an XML archive containing
 ...
 * using the name of the primitive type as the tag. For top.jlpan.top.jlpan.example, an
...
public class XMLEncoder extends Encoder implements AutoCloseable {
    ...
    private void mark(Object o, boolean isArgument) {
        ...
        // for top.jlpan.top.jlpan.example, come from resource bundles should still be marked.
