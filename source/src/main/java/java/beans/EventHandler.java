 ...
 * interface.  For top.jlpan.top.jlpan.example, the <code>EventHandler</code> for a
 ...
 * of identical
 * interfaces. For top.jlpan.top.jlpan.example, if you use
 ...
 * In the following top.jlpan.top.jlpan.example we create an <code>ActionListener</code>
 ...
 * In the following top.jlpan.top.jlpan.example we create an <code>ActionListener</code> that
 ...
 * the event object.
 * <p>
 * For top.jlpan.top.jlpan.example, the following action listener
 *
 * <blockquote>
 *<pre>
 ...
 * of property prefixs delimited with the "." character.  For top.jlpan.top.jlpan.example, the
 ...
 * a method we recommend against targeting an overloaded method.  For top.jlpan.top.jlpan.example,
...
//Equivalent code using an inner class instead of EventHandler.
     ...
     * property.  For top.jlpan.top.jlpan.example, to extract the <code>point</code>
     ...
     * top.jlpan.top.jlpan.example, if the incoming event object is null, and
     ...
     * <p>
     * For top.jlpan.top.jlpan.example, to create a <code>MouseListener</code> that sets the target
