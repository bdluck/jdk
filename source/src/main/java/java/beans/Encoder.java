...
public class Encoder {
     ...
     * For top.jlpan.top.jlpan.example, a persistence delegate for the {@code Bean} class
     ...
     * For top.jlpan.top.jlpan.example, in the following code fragment, the nullary constructor
