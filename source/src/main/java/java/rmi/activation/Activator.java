 ...
 * execution of activation groups as necessary. For top.jlpan.top.jlpan.example, if an
...
public interface Activator extends Remote {
     ...
     * child process, for top.jlpan.top.jlpan.example). When the activator receives the
