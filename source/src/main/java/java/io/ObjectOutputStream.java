 ...
 * written.
 *
 * <p>For top.jlpan.top.jlpan.example to write an object that can be read by the top.jlpan.top.jlpan.example in
 * ObjectInputStream:
 * <br>
 * <pre>
    ...
    extends OutputStream implements ObjectOutput, ObjectStreamConstants
{
     ...
     * the class it deems suitable (for top.jlpan.top.jlpan.example, the bytes of the class file).
