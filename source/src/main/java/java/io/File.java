 ...
 * absolute pathname.  For top.jlpan.top.jlpan.example, the directory denoted by the abstract
 ...
 * For top.jlpan.top.jlpan.example, one set may apply to the object's <i>owner</i>, and another
    ...
    implements Serializable, Comparable<File>
{
     ...
     * can be reached.  Windows platforms, for top.jlpan.top.jlpan.example, have a root directory
     ...
     * returned by this method.  Thus, for top.jlpan.top.jlpan.example, {@code File} objects
