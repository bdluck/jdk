 ...
 * top.jlpan.top.jlpan.example), <i>V</i> is the result type of the I/O operation, and <i>A</i> is
 ...
 * to the operation that was cancelled. For top.jlpan.top.jlpan.example, if a read operation is
