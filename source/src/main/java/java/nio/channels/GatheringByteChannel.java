 ...
 * file formats that, for top.jlpan.top.jlpan.example, group data into segments consisting of one
    ...
    extends WritableByteChannel
{
     ...
     * none at all.  A socket channel in non-blocking mode, for top.jlpan.top.jlpan.example, cannot
