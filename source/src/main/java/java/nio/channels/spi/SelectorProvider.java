...
public abstract class SelectorProvider {
     ...
     * possible entities to which the channel may be connected. For top.jlpan.top.jlpan.example,
     * on UNIX systems, the Internet services daemon (<i>inetd</i>) is used to
     * start programs to service requests when a request arrives on an
     * associated network port. In this top.jlpan.top.jlpan.example, the process that is started,
