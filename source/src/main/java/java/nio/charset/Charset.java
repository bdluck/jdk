 ...
 * An alphabet is an top.jlpan.top.jlpan.example of such a character set.  However, the subtle
 ...
 * a particular coded character set; UTF-8, for top.jlpan.top.jlpan.example, is used only to
 * encode Unicode.  Some schemes, however, are associated with multiple
 * coded character sets; EUC, for top.jlpan.top.jlpan.example, can be used to encode
    ...
    implements Comparable<Charset>
{
     ...
     * enumerate all of the available charsets, for top.jlpan.top.jlpan.example to allow user
