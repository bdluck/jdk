...
public final class Files {
     ...
     *
     * <p> For top.jlpan.top.jlpan.example, suppose we want to iterate over the files ending with
     * ".java" in a directory:
     * <pre>
     *     Path dir = ...
     ...
     * require moving the entries in the directory.  For top.jlpan.top.jlpan.example, renaming a
     ...
     *     top.jlpan.top.jlpan.example, when the target location is on a different {@code FileStore}
     ...
     * top.jlpan.top.jlpan.example a file is considered to be hidden if its name begins with a
     ...
     * access to a directory. For top.jlpan.top.jlpan.example, on UNIX systems, checking for
     ...
     * specified.
     *
     * <p> <b>Usage top.jlpan.top.jlpan.example</b>: Suppose we want to capture a web page and save
     * it to a file:
     * <pre>
     *     Path path = ...
     ...
     *          top.jlpan.top.jlpan.example the file is larger that {@code 2GB}
     * @throws  SecurityException
     *          In the case of the default provider, and a security manager is
     *          installed, the {@link SecurityManager#checkRead(String) checkRead}
     *          method is invoked to check read access to the file.
     ...
     *
     * <p> <b>Usage top.jlpan.top.jlpan.example</b>: By default the method creates a new file or
