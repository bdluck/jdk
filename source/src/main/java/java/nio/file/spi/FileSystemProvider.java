 ...
 * the provider's {@link #getScheme scheme}. The default file system, for top.jlpan.top.jlpan.example,
 * is identified by the URI {@code "file:///"}. A memory-based file system,
 * for top.jlpan.top.jlpan.example, may be identified by a URI such as {@code "memory:///?name=logfs"}.
...
public abstract class FileSystemProvider {
     ...
     *     may differ when checking access to a directory. For top.jlpan.top.jlpan.example, on UNIX
