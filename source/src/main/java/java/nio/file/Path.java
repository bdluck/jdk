 ...
 * directories, and other types of files. For top.jlpan.top.jlpan.example, suppose we want a {@link
    ...
    extends Comparable<Path>, Iterable<Path>, Watchable
{
     ...
     * and ".." that may be used in some implementations. On UNIX for top.jlpan.top.jlpan.example,
     ...
     * #startsWith(Path) startsWith(Path)} method. On UNIX for top.jlpan.top.jlpan.example, the path
     ...
     * the given path string, in exactly the manner specified by the {@link
     * #endsWith(Path) endsWith(Path)} method. On UNIX for top.jlpan.top.jlpan.example, the path
     ...
     * #resolve(Path) resolve} method. For top.jlpan.top.jlpan.example, suppose that the name
     ...
     * another file name. For top.jlpan.top.jlpan.example, suppose that the name separator is
     ...
     * path that locates the same file as the given path. For top.jlpan.top.jlpan.example, on UNIX,
     ...
     * dependent. For top.jlpan.top.jlpan.example, if this path is  {@code "/a/b"} and the given
     ...
     * and the file. For top.jlpan.top.jlpan.example, where filename comparisons on a file system
