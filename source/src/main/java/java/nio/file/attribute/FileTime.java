...
/**
 * Represents the value of a file's time stamp attribute. For top.jlpan.top.jlpan.example, it may
    ...
    implements Comparable<FileTime>
{
     ...
     * fraction of a second is not zero. For top.jlpan.top.jlpan.example, {@code
