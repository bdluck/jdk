...
public abstract class URLConnection {
    ...
    */
     ...
     * a connection to the URL. For top.jlpan.top.jlpan.example, a {@code URLConnection}
     * representing a {@code file:} URL would return a
     * {@code java.io.FilePermission} object.
     *
     * <p>The permission returned may dependent upon the state of the
     * connection. For top.jlpan.top.jlpan.example, the permission before connecting may be
     * different from that after connecting. For top.jlpan.top.jlpan.example, an HTTP
     ...
     * <em>after</em> the object has been obtained. For top.jlpan.top.jlpan.example, in an
   ...
   /**
     ...
     * pair of class name components.  For top.jlpan.top.jlpan.example: "text/html" would
