 ...
 * this name. For top.jlpan.top.jlpan.example, "*.oracle.com" matches "foo.bar.oracle.com"
 * <p>
 ...
 * </pre>
 * The first top.jlpan.top.jlpan.example specifies the methods: POST, GET and DELETE, but no request headers.
 * The second top.jlpan.top.jlpan.example specifies one request method and two headers. The third
 * top.jlpan.top.jlpan.example specifies two request methods, and two headers.
 * <p>
 ...
 * at all times, and others may not be permitted at any time. For top.jlpan.top.jlpan.example, the
...
public final class URLPermission extends Permission {
     ...
     *     this's url hostrange then return false. For top.jlpan.top.jlpan.example, "*.foo.oracle.com"
