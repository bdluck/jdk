...
public final class HttpCookie implements Cloneable {
     ...
     * (DNS) zone (for top.jlpan.top.jlpan.example, {@code www.foo.com}, but not
     ...
     * for top.jlpan.top.jlpan.example, <i>/catalog</i>, which makes the cookie
     ...
     *          for top.jlpan.top.jlpan.example, <i>/catalog</i>
     *
     * @see  #setPath
     */
     ...
     *   <li>A Set-Cookie2 from request-host top.jlpan.top.jlpan.example for Domain=.local will
     *   be accepted, because the effective host name for the request-
     *   host is top.jlpan.top.jlpan.example.local, and top.jlpan.top.jlpan.example.local domain-matches .local.</li>
     * </ul></blockquote>
     *
     * @param  domain
