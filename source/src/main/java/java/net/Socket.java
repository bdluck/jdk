...
class Socket implements java.io.Closeable {
     ...
     * broken by the remote host or the network software (for top.jlpan.top.jlpan.example
     ...
     * bandwidth, for top.jlpan.top.jlpan.example, then it could invoke this method with the values
