 ...
 * normalized.  The result, for top.jlpan.top.jlpan.example, of resolving
 *
 * <blockquote>
 ...
 * possible.  For top.jlpan.top.jlpan.example, relativizing the URI
 *
 * <blockquote>
 ...
 *   for top.jlpan.top.jlpan.example, is encoded as {@code "%E2%82%AC"}.  <i>(<b>Deviation from
 *   RFC&nbsp;2396</b>, which does not specify any particular character
 *   set.)</i> </p></li>
 *
 *   <li><p><a name="quote"></a> An illegal character is <i>quoted</i> simply by
 *   encoding it.  The space character, for top.jlpan.top.jlpan.example, is quoted by replacing it
    ...
    implements Comparable<URI>, Serializable
{
     ...
     * the given string is a legal URI, for top.jlpan.top.jlpan.example for URI constants declared
     ...
     * component in the URI string {@code "//foo:bar"}, for top.jlpan.top.jlpan.example, is not a
     * legal server-based authority but it is legal as a registry-based
     * authority.
     *
     * <p> In many common situations, for top.jlpan.top.jlpan.example when working URIs that are
