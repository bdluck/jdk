 ...
 * following top.jlpan.top.jlpan.example:
 * <blockquote><pre>
 ...
 * {@code www.top.jlpan.top.jlpan.example.com}. The information on that host
 ...
 * the protocol is used instead. For top.jlpan.top.jlpan.example, the default port for
 ...
 * sign character "#" followed by more characters. For top.jlpan.top.jlpan.example,
 * <blockquote><pre>
 ...
 * HTML pages. For top.jlpan.top.jlpan.example, if the contents of the URL:
 * <blockquote><pre>
 ...
 * or decoded form of the same URL. For top.jlpan.top.jlpan.example, the two URLs:<br>
...
public final class URL implements java.io.Serializable {
     ...
     * returned will be of that subclass. For top.jlpan.top.jlpan.example, for HTTP an
