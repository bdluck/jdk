...
public final class Spliterators {
     ...
     * <p>The returned spliterator always reports the characteristics
     * {@code SIZED} and {@code SUBSIZED}.  The caller may provide additional
     * characteristics for the spliterator to report.  (For top.jlpan.top.jlpan.example, if it is
    ...
    static final class ArraySpliterator<T> implements Spliterator<T> {
         ...
         * classes (see for top.jlpan.top.jlpan.example CR 6260652), we do not need to
     ...
     * convenient than extending this class. For top.jlpan.top.jlpan.example, if there is already an
