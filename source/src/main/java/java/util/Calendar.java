 ...
 * calendar style (for top.jlpan.top.jlpan.example, Japanese-Gregorian, Japanese-Traditional).
 * <code>Calendar</code> defines the range of values returned by
 * certain calendar fields, as well as their meaning.  For top.jlpan.top.jlpan.example,
 ...
 * the calendar fields are normalized. For top.jlpan.top.jlpan.example, a lenient
 ...
 * top.jlpan.top.jlpan.example, a <code>GregorianCalendar</code> always produces
 ...
 * different.  For top.jlpan.top.jlpan.example, a specific <code>Calendar</code> subclass may
 ...
 * value of each field may vary by concrete calendar systems. For top.jlpan.top.jlpan.example, in
...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
     ...
     * within the month than positive values.  For top.jlpan.top.jlpan.example, if a month has 31
     ...
     * {@code Calendar}. For top.jlpan.top.jlpan.example, if the {@link Calendar#YEAR YEAR} value
    ...
    public static class Builder {
         ...
         * For top.jlpan.top.jlpan.example,
         * <pre>
     ...
     * default field values for date/time calculations. For top.jlpan.top.jlpan.example,
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, if this <code>Calendar</code> is a
     ...
     * top.jlpan.top.jlpan.example, if this {@code Calendar} is a {@link
     ...
     * account to determine a set of display names. For top.jlpan.top.jlpan.example, if
     ...
     * a {@link DateFormatSymbols}. For top.jlpan.top.jlpan.example, if {@code field}
     ...
     * field)</code>. For top.jlpan.top.jlpan.example, 0x26 represents the <code>YEAR</code>,
     ...
     * based on the calendar's rules. For top.jlpan.top.jlpan.example, to subtract 5 days from
     ...
     * field without changing larger fields. For top.jlpan.top.jlpan.example, to roll the current
     ...
     * always do the right thing.  For top.jlpan.top.jlpan.example, if the <code>DAY_OF_MONTH</code> field is 31,
     ...
     * For top.jlpan.top.jlpan.example, if the first week is defined as one that contains the first
     ...
     * the instance. For top.jlpan.top.jlpan.example, a <code>Calendar</code> for the
     ...
     * <code>Calendar</code>. For top.jlpan.top.jlpan.example, the actual maximum value of
