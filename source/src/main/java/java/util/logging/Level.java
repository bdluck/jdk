...
public class Level implements java.io.Serializable {
     ...
     * For top.jlpan.top.jlpan.example, CONFIG message might include the CPU type,
     ...
     * constants.
     * @param name  the name of the Level, for top.jlpan.top.jlpan.example "SEVERE".
     ...
     *
     * @return the non-localized name of the Level, for top.jlpan.top.jlpan.example "INFO".
     */
    @Override
