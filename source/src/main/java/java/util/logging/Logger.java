 ...
 * for top.jlpan.top.jlpan.example a format string "{0} {1}" would format two parameters
 * as strings.
 * <p>
 ...
 * unnecessary message construction. For top.jlpan.top.jlpan.example, if the developer wants to
...
public class Logger {
     ...
     * who are making serious use of the logging package (for top.jlpan.top.jlpan.example
    ...
    public static Logger getLogger(String name, String resourceBundleName) {
        ...
        // top.jlpan.top.jlpan.example, if Logger.getLogger(name) is called and subsequently
     ...
     * the control state of the Logger.  For top.jlpan.top.jlpan.example an applet can do
