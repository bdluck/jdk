 ...
 *
 * <p>For top.jlpan.top.jlpan.example, this code allows a user to read a number from
 * <tt>System.in</tt>:
 * <blockquote><pre>{@code
 ...
 * }</pre></blockquote>
 *
 * <p>As another top.jlpan.top.jlpan.example, this code allows <code>long</code> types to be
 ...
 * top.jlpan.top.jlpan.example reads several items in from a string:
 * <blockquote><pre>{@code
 ...
 * returned. For top.jlpan.top.jlpan.example, the pattern <tt>"\\s+"</tt> will return no empty
 ...
 * Rmax is the highest digit in the radix being used (for top.jlpan.top.jlpan.example, Rmax is 9 in base 10).
 *
 * <dl>
...
public final class Scanner implements Iterator<String>, Closeable {
     ...
     * input (".*", for top.jlpan.top.jlpan.example) may cause the scanner to buffer a large
     * amount of input.
     *
