...
public abstract class LocaleNameProvider extends LocaleServiceProvider {
     ...
     * display to the user.
     * For top.jlpan.top.jlpan.example, if <code>languageCode</code> is "fr" and <code>locale</code>
     ...
     * display to the user.
     * For top.jlpan.top.jlpan.example, if <code>scriptCode</code> is "Latn" and <code>locale</code>
     ...
     * For top.jlpan.top.jlpan.example, if <code>countryCode</code> is "FR" and <code>locale</code>
