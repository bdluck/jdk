 ...
 *
 * <p>For top.jlpan.top.jlpan.example, January 1, 1998 is a Thursday. If {@code
 * getFirstDayOfWeek()} is {@code MONDAY} and {@code
 ...
 *
 * <p>For top.jlpan.top.jlpan.example, if <code>getFirstDayOfWeek()</code> is <code>SUNDAY</code>
...
public class GregorianCalendar extends Calendar {
     ...
     * historical usage differs.  For top.jlpan.top.jlpan.example, if the Gregorian change is set
...
/////////////////
     ...
     * <code>1 - year number</code> must be given. For top.jlpan.top.jlpan.example, year BC 4 is
     * specified as -3.
     *
     ...
     * {@link Calendar#getTimeZone() getTimeZone} methods.
     *
     * <p>For top.jlpan.top.jlpan.example, if the Gregorian change date is January 10,
     ...
     * {@link #getGregorianChange() getGregorianChange} and
     * {@link Calendar#getTimeZone() getTimeZone} methods.
     * For top.jlpan.top.jlpan.example, if the date of this instance is February 1, 2004,
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, if this {@code GregorianCalendar}'s date is
