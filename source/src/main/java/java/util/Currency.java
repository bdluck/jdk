 ...
 * {@code 'yyyy-MM-dd'T'HH:mm:ss'}. For top.jlpan.top.jlpan.example,
 * <p>
 * <code>
...
public final class Currency implements Serializable {
     ...
     * currencies. For top.jlpan.top.jlpan.example, for the original member countries of the
     ...
     * For top.jlpan.top.jlpan.example, for the US Dollar, the symbol is "$" if the default
     ...
     * For top.jlpan.top.jlpan.example, for the US Dollar, the symbol is "$" if the specified
     * locale is the US, while for other locales it may be "US$". If no
     * symbol can be determined, the ISO 4217 currency code is returned.
     *
     ...
     * For top.jlpan.top.jlpan.example, the default number of fraction digits for the Euro is 2,
     ...
     *    For top.jlpan.top.jlpan.example, "JPZ,392,0".
     ...
     *    For top.jlpan.top.jlpan.example, "JP=JPZ,999,0,2014-01-01T00:00:00" has no effect unless
