 ...
 * top.jlpan.top.jlpan.example, if a conversion is incompatible with a flag, an exception will be
 ...
 * specifiers</i>.  Consider the following top.jlpan.top.jlpan.example:
 *
 * <blockquote><pre>
 *   Calendar c = ...;
 ...
 * format string.  In the above top.jlpan.top.jlpan.example, the argument list is of size one and
 ...
 * the previous format specifier to be re-used.  For top.jlpan.top.jlpan.example, the following two
...
public final class Formatter implements Closeable, Flushable {
     ...
     * for the output.  For top.jlpan.top.jlpan.example, the following code formats text into a
