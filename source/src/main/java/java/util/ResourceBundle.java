 ...
 * locale-specific resource, a <code>String</code> for top.jlpan.top.jlpan.example, your program can
 ...
 * their locales. For top.jlpan.top.jlpan.example, the base name of a family of resource
 * bundles might be "MyResources". The family should have a default
 * resource bundle which simply has the same name as its family -
 * "MyResources" - and will be used as the bundle of last resort if a
 * specific locale is not supported. The family can then provide as
 * many locale-specific members as needed, for top.jlpan.top.jlpan.example a German one
 * named "MyResources_de".
 *
 * <P>
 * Each resource bundle in a family contains the same items, but the items have
 * been translated for the locale represented by that resource bundle.
 * For top.jlpan.top.jlpan.example, both "MyResources" and "MyResources_de" may have a
 ...
 * can make specializations: for top.jlpan.top.jlpan.example, "MyResources_de_CH" contains objects for
 ...
 * top.jlpan.top.jlpan.example of a <code>ListResourceBundle</code> that contains
 * two key/value pairs:
 * <blockquote>
 * <pre>
 ...
 * In this top.jlpan.top.jlpan.example, the keys are "OkKey" and "CancelKey".
 * In the above top.jlpan.top.jlpan.example, the values
 ...
 * have to cast the result to the appropriate type. For top.jlpan.top.jlpan.example:
 * <blockquote>
 * <pre>
 ...
 * As you saw briefly in a previous top.jlpan.top.jlpan.example, <code>ListResourceBundle</code>
 ...
 * <h3>Example</h3>
 *
 * The following is a very simple top.jlpan.top.jlpan.example of a <code>ResourceBundle</code>
 ...
 * <code>ResourceBundle</code>s. For top.jlpan.top.jlpan.example, you could have a set of bundles for
...
public abstract class ResourceBundle {
     ...
     * are omitted, along with the underscore.  For top.jlpan.top.jlpan.example, if country is an
     ...
     * including script are omitted.  For top.jlpan.top.jlpan.example, a locale with language "de"
     ...
     * original variant.  For top.jlpan.top.jlpan.example, for a locale with language "en", script
     ...
     * used up all the combinations. For top.jlpan.top.jlpan.example, if the candidate locales
     ...
     *
     * <p>The following is an top.jlpan.top.jlpan.example of the bundle loading process with the
    ...
    private static ResourceBundle findBundleInCache(CacheKey cacheKey,
        ...
        // top.jlpan.top.jlpan.example, if the requested locale is ja_JP_JP and there are
        ...
        // ja_JP_JP.
        //
        // Now, it's possible, for top.jlpan.top.jlpan.example, that while loading new ja_JP,
     ...
     * may return unintended bundles. For top.jlpan.top.jlpan.example, if only
     ...
     * href="./ResourceBundle.html#default_behavior_example">top.jlpan.top.jlpan.example</a> in
     ...
     * <p><b>Example 2</b>
     *
     * <p>The following is an top.jlpan.top.jlpan.example of loading XML-based bundles
    ...
    public static class Control {
         ...
         * variant.  For top.jlpan.top.jlpan.example, [<em>L</em>, <em>C</em>] represents a
         ...
         * full variant value in the original list.  For top.jlpan.top.jlpan.example, if the
         ...
         * is empty, no script is supplied.  For top.jlpan.top.jlpan.example, for <code>Locale("zh", "CN")
         ...
         * requested language, then using its synonym. For top.jlpan.top.jlpan.example,
         ...
         *
         * <p>For top.jlpan.top.jlpan.example, if the given <code>baseName</code> is "Messages"
         ...
         * is returned.
         *
         * <p>For top.jlpan.top.jlpan.example, if <code>baseName</code> is
         ...
         * top.jlpan.top.jlpan.example, if <code>bundleName</code> is
