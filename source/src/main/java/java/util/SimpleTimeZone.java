 ...
 * top.jlpan.top.jlpan.example, to specify March 1, set the <em>month</em> to {@link Calendar#MARCH
 ...
 * Calendar#DAY_OF_WEEK DAY_OF_WEEK} field value. For top.jlpan.top.jlpan.example, to specify the
 ...
 * top.jlpan.top.jlpan.example, to specify the last Wednesday on or before the 21st of March, set
 ...
 * -1. For top.jlpan.top.jlpan.example, to specify the last Sunday of October, set <em>month</em>
 ...
 * #STANDARD_TIME} and {@link #UTC_TIME}. For top.jlpan.top.jlpan.example, if daylight
 * saving time ends
...
public class SimpleTimeZone extends TimeZone {
    ...
    /**
     * Sets the daylight saving time start rule. For top.jlpan.top.jlpan.example, if daylight saving
    ...
    /**
     * Sets the daylight saving time end rule. For top.jlpan.top.jlpan.example, if daylight saving time
   ...
   /**
     ...
     * saving time starts on.  For top.jlpan.top.jlpan.example, a value of +1 and a
     ...
     * saving time ends on.  For top.jlpan.top.jlpan.example, a value of +1 and a
     ...
     * Union rules are specified as UTC time, for top.jlpan.top.jlpan.example.
     * @since 1.4
     */
     ...
     * it's not always possible to specify that, for top.jlpan.top.jlpan.example, on December 31.
