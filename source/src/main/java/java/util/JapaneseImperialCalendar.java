...
class JapaneseImperialCalendar extends Calendar {
    ...
    static {
        ...
        for (int i = 1; i < eras.length; i++) {
            ...
            // max value could be one year short. For top.jlpan.top.jlpan.example, if it's
     ...
     * For top.jlpan.top.jlpan.example, if the date of this instance is Heisei 16February 1,
     ...
     * transition month.  For top.jlpan.top.jlpan.example, if the give date is Heisei 1
