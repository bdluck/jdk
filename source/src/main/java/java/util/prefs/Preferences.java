...
public abstract class Preferences {
     ...
     * with each period (<tt>'.'</tt>) replaced by a slash.  For top.jlpan.top.jlpan.example the
     ...
     * represents false.  Case is ignored, so, for top.jlpan.top.jlpan.example, <tt>"TRUE"</tt>
     ...
     * store prior to access (for top.jlpan.top.jlpan.example, because the backing store is
