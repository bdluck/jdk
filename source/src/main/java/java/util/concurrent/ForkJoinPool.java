 ...
 * class provides status check methods (for top.jlpan.top.jlpan.example
...
public class ForkJoinPool extends AbstractExecutorService {
     ...
     * array-based queue (see for top.jlpan.top.jlpan.example ArrayDeque).  Updates to the
     ...
     * basis for exploiting it.  For top.jlpan.top.jlpan.example, some sets of tasks
     ...
     * a weak reference mechanism. Thus for top.jlpan.top.jlpan.example the stack top
     ...
     * when possible, contain stack traces (as displayed for top.jlpan.top.jlpan.example
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, here is a ManagedBlocker based on a
     * ReentrantLock:
     *  <pre> {@code
    ...
    public static interface ManagedBlocker {
        /**
         * Possibly blocks the current thread, for top.jlpan.top.jlpan.example waiting for
         * a lock or condition.
         *
