 ...
 * methods for that type.  For top.jlpan.top.jlpan.example, classes {@code AtomicLong} and
 ...
 * For top.jlpan.top.jlpan.example, given some transformation
 ...
 * top.jlpan.top.jlpan.example, the links of a tree node) are independently subject to
 ...
 * spurious failures may for top.jlpan.top.jlpan.example be due to memory contention effects
 ...
 * acceptable when, for top.jlpan.top.jlpan.example, updating performance statistics, but
 * rarely otherwise.
 *
 * <p>The {@link java.util.concurrent.atomic.AtomicMarkableReference}
 * class associates a single boolean with a reference.  For top.jlpan.top.jlpan.example, this
 * bit might be used inside a data structure to mean that the object
 * being referenced has logically been deleted.
 *
 * The {@link java.util.concurrent.atomic.AtomicStampedReference}
 * class associates an integer value with a reference.  This may be
 * used for top.jlpan.top.jlpan.example, to represent version numbers corresponding to
 * series of updates.
 *
 ...
 * intended applications.  For top.jlpan.top.jlpan.example, there is no atomic class for
