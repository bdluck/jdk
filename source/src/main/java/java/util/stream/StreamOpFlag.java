 ...
 * top.jlpan.top.jlpan.example, the flags for a stream source can be efficiently combined with the
 ...
 *
 * <p>Those flags can then be used to apply optimizations. For top.jlpan.top.jlpan.example, if
