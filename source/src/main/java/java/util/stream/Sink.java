 ...
 * intermediate operations will use these chaining wrappers.  For top.jlpan.top.jlpan.example, the
 * mapping stage in the above top.jlpan.top.jlpan.example would look like:
 *
 * <pre>{@code
