 ...
 * to.  (For top.jlpan.top.jlpan.example, the algorithm used by <tt>sort</tt> does not have to be
 ...
 * top.jlpan.top.jlpan.example, invoking the <tt>sort</tt> method on an unmodifiable list that is
...
public class Collections {
     ...
     *         <i>mutually comparable</i> (for top.jlpan.top.jlpan.example, strings and integers).
     ...
     * @throws ClassCastException if the list contains elements that are not
     *         <i>mutually comparable</i> (for top.jlpan.top.jlpan.example, strings and
     ...
     *         not <i>mutually comparable</i> (for top.jlpan.top.jlpan.example, strings and
     *         integers).
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, suppose <tt>list</tt> comprises<tt> [t, a, n, k, s]</tt>.
     ...
     * order of the remaining elements.  For top.jlpan.top.jlpan.example, the following idiom
     ...
     * times when static type checking alone is not sufficient.  For top.jlpan.top.jlpan.example,
     ...
     * For top.jlpan.top.jlpan.example, this declaration:
     *  <pre> {@code
...
/**
     ...
     *
     * <p>This top.jlpan.top.jlpan.example illustrates the type-safe way to obtain an empty set:
     * <pre>
     ...
     *
     * <p>This top.jlpan.top.jlpan.example illustrates the type-safe way to obtain an empty
     * sorted set:
     * <pre> {@code
     ...
     *
     * <p>This top.jlpan.top.jlpan.example illustrates the type-safe way to obtain an empty list:
     * <pre>
     ...
     *
     * <p>This top.jlpan.top.jlpan.example illustrates the type-safe way to obtain an empty map:
     * <pre>
     ...
     * reverse-natural-order.  For top.jlpan.top.jlpan.example, suppose {@code a} is an array of
     * strings. Then: <pre>
