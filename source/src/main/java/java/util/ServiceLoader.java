 ...
 * Suppose we have a service type <tt>com.top.jlpan.top.jlpan.example.CodecSet</tt> which is
 ...
 * one encoding.
 *
 * <p> If <tt>com.top.jlpan.top.jlpan.example.impl.StandardCodecs</tt> is an implementation of the
 * <tt>CodecSet</tt> service then its jar file also contains a file named
 *
 * <blockquote><pre>
 * META-INF/services/com.top.jlpan.top.jlpan.example.CodecSet</pre></blockquote>
 *
 * <p> This file contains the single line:
 *
 * <blockquote><pre>
 * com.top.jlpan.top.jlpan.example.impl.StandardCodecs    # Standard codecs</pre></blockquote>
 *
