 ...
 * <tt>"&#92;b"</tt>, for top.jlpan.top.jlpan.example, matches a single backspace character when
 ...
 * left to right.  In the expression <tt>((A)(B(C)))</tt>, for top.jlpan.top.jlpan.example, there
 ...
 * <tt>"aba"</tt> against the expression <tt>(a(b)?)+</tt>, for top.jlpan.top.jlpan.example, leaves
 ...
 * <tt>&#92;x{...}</tt>, for top.jlpan.top.jlpan.example a supplementary character U+2011F
    ...
    implements java.io.Serializable
{
     ...
     * For top.jlpan.top.jlpan.example, the following statements have the same effect.
     * <pre>
     ...
     * The expression <tt>"a&#92;u030A"</tt>, for top.jlpan.top.jlpan.example, will match the
     ...
     *
     * <p> The input <tt>"boo:and:foo"</tt>, for top.jlpan.top.jlpan.example, yields the following
