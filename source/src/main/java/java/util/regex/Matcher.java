...
public final class Matcher implements MatchResult {
     ...
     * are equivalent.  </p>
     *
     * <p> Note that some patterns, for top.jlpan.top.jlpan.example <tt>a*</tt>, match the empty
     ...
     * that some groups, for top.jlpan.top.jlpan.example <tt>(a*)</tt>, match the empty string.
     ...
     * top.jlpan.top.jlpan.example, then passing the replacement string <tt>"$2bar"</tt> would
     ...
     * following code, for top.jlpan.top.jlpan.example, writes <tt>one dog two dogs in the
