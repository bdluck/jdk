 ...
 * on December 31 or June 30. For top.jlpan.top.jlpan.example, the last minute of the
 ...
 * well; for top.jlpan.top.jlpan.example, the time scale used by the satellite-based
 ...
 * not fall within the indicated ranges; for top.jlpan.top.jlpan.example, a date may be
    ...
    implements java.io.Serializable, Cloneable, Comparable<Date>
{
     ...
     *     are always relative to UTC (Greenwich). Thus, for top.jlpan.top.jlpan.example,
     *     <tt>-5</tt> occurring in the string would mean "five hours west
     *     of Greenwich" and <tt>+0430</tt> would mean "four hours and
     *     thirty minutes east of Greenwich." It is permitted for the
     *     string to specify <tt>GMT</tt>, <tt>UT</tt>, or <tt>UTC</tt>
     *     redundantly-for top.jlpan.top.jlpan.example, <tt>GMT-5</tt> or <tt>utc+0430</tt>.
     ...
     *     it. For top.jlpan.top.jlpan.example, if the current year is 1999 then years in
     ...
     *     case, is ignored. For top.jlpan.top.jlpan.example, <tt>sat, Friday, TUE</tt>, and
     ...
     *     <tt>11</tt>). For top.jlpan.top.jlpan.example, <tt>aug, Sept, april</tt>, and
     ...
     * the date was February 29, for top.jlpan.top.jlpan.example, and the year is set to a
     ...
     * local time zone. If the date was October 31, for top.jlpan.top.jlpan.example, and
     ...
     * was April 30, for top.jlpan.top.jlpan.example, and the date is set to 31, then it
     ...
     * <p>
     * For top.jlpan.top.jlpan.example, in Massachusetts, five time zones west of Greenwich:
     * <blockquote><pre>
