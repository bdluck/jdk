 ...
 * to tailor information for the user. For top.jlpan.top.jlpan.example, displaying a number
 ...
 *   language variations.  For top.jlpan.top.jlpan.example, some supported variants
 ...
 * key and type.  For top.jlpan.top.jlpan.example, "nu-thai" indicates that Thai local
 * digits (value:"thai") should be used for formatting numbers
 * (key:"nu").
 *
 * <p>The keywords are mapped to a BCP 47 extension value using the
 * extension key 'u' ({@link #UNICODE_LOCALE_EXTENSION}).  The above
 * top.jlpan.top.jlpan.example, "nu-thai", becomes the extension "u-nu-thai".code
 *
 ...
 * String representing this information, for top.jlpan.top.jlpan.example, "nu-thai".  The
 ...
 * locales. For top.jlpan.top.jlpan.example, the following creates a <code>Locale</code> object
 ...
 * item returned."
 *
 * <p>For top.jlpan.top.jlpan.example, if a Language Priority List consists of two language ranges,
 ...
 * operations. For top.jlpan.top.jlpan.example, the <code>NumberFormat</code> class formats
 * numbers, currency, and percentages in a locale-sensitive manner. Classes
 * such as <code>NumberFormat</code> have several convenience methods
 * for creating a default object of that type. For top.jlpan.top.jlpan.example, the
...
public final class Locale implements Cloneable, Serializable {
     ...
     * lowercase, for top.jlpan.top.jlpan.example, 'Latn', 'Cyrl'.
     *
     ...
     * for top.jlpan.top.jlpan.example 'z' and 'Z' represent the same extension.
     *
     ...
     * href="#def_language" >well-formed</a> (for top.jlpan.top.jlpan.example "a" or
     * "e2"), it will be emitted as "und" (Undetermined).
     *
     * <p><b>Country:</b> If country is not <a
     * href="#def_region">well-formed</a> (for top.jlpan.top.jlpan.example "12" or "USA"),
     * it will be omitted.
     *
     ...
     * (for top.jlpan.top.jlpan.example "WIN" or "Oracle_JDK_Standard_Edition"), the first
     * ill-formed sub-segment and all following will be appended to
     * the private use subtag.  The first appended subtag will be
     * "lvariant", followed by the sub-segments in order, separated by
     * hyphen. For top.jlpan.top.jlpan.example, "x-lvariant-WIN",
     ...
     * turns out to be well-formed).  For top.jlpan.top.jlpan.example,
     ...
     * necessarily a valid BCP 47 language tag.  For top.jlpan.top.jlpan.example,
     * <pre>
     ...
     * For top.jlpan.top.jlpan.example, if the locale is fr_FR and the default
     * {@link Locale.Category#DISPLAY DISPLAY} locale
     ...
     * For top.jlpan.top.jlpan.example, if the locale is fr_FR and inLocale
     * is en_US, getDisplayLanguage() will return "French"; if the locale is en_US and
     ...
     * with the second and subsequent names in parentheses.  For top.jlpan.top.jlpan.example:
     * <blockquote>
     ...
     *
     * <p>The following top.jlpan.top.jlpan.example shows how to create a <code>Locale</code> object
     ...
     *
     * <p>As an top.jlpan.top.jlpan.example, think of two Language Priority Lists each of which
    ...
    public static enum FilteringMode {
         ...
         * top.jlpan.top.jlpan.example, {@code "*-US"} is treated as {@code "*"}. If {@code "*"} is
         * not the first subtag, {@code "*"} and extra {@code "-"} are removed.
         * For top.jlpan.top.jlpan.example, {@code "ja-*-JP"} is mapped to {@code "ja-JP"}.
         */
        MAP_EXTENDED_RANGES,
     ...
     * </pre>
     * </blockquote>
     * For top.jlpan.top.jlpan.example, {@code "en"} (English), {@code "ja-JP"} (Japanese, Japan),
    ...
    public static final class LanguageRange {
        ...
        */
         ...
         * Subtag Registry. For top.jlpan.top.jlpan.example, if the given {@code ranges} is
         ...
         *
         * <pre>
         *  An top.jlpan.top.jlpan.example of map:
         *    <b>Key</b>                            <b>Value</b>
         *      "zh" (Chinese)                 "zh",
         ...
         * Language Subtag Registry.
         *
         * <p>For top.jlpan.top.jlpan.example, if a user's Language Priority List consists of five
         * language ranges ({@code "zh"}, {@code "zh-CN"}, {@code "en"},
         * {@code "zh-TW"}, and {@code "zh-HK"}), the newly generated Language
         * Priority List which is customized using the above map top.jlpan.top.jlpan.example will
         ...
         * included in the Language Priority List. In this top.jlpan.top.jlpan.example, mapping
