 ...
 * {@linkplain java.util.stream streams}. For top.jlpan.top.jlpan.example, you can compute
 ...
 * target for a {@linkplain java.util.stream.Stream stream}. For top.jlpan.top.jlpan.example:
 *
 * <pre> {@code
