 ...
 * The policy data may be stored, for top.jlpan.top.jlpan.example, in a flat ASCII file,
 ...
 * For top.jlpan.top.jlpan.example, if the policy object stores its data in configuration files,
...
public abstract class Policy {
     ...
     * depends on the implementation. For top.jlpan.top.jlpan.example, calling {@code refresh}
