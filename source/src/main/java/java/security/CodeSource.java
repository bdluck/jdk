...
public class CodeSource implements java.io.Serializable {
     ...
     * </ul>
     * <p>
     * For top.jlpan.top.jlpan.example, the codesource objects with the following locations
    ...
    private boolean matchLocation(CodeSource that) {
        ...
        if (location.getFile().endsWith("/-")) {
            ...
            // For top.jlpan.top.jlpan.example, "/a/b/-" implies anything that starts with
            // "/a/b/"
            ...
            // Exact matches only.
            // For top.jlpan.top.jlpan.example, "/a/b" and "/a/b/" both imply "/a/b/"
