 ...
 * errors during their operation, for top.jlpan.top.jlpan.example a failure to communicate with a
...
public abstract class Provider extends Properties {
     ...
     * (for top.jlpan.top.jlpan.example, {@code MessageDigest})
     * @param algorithm the case insensitive algorithm name (or alternate
     * alias) of the service requested (for top.jlpan.top.jlpan.example, {@code SHA-1})
     *
    ...
    public static class Service {
        ...
        /**
         * Get the type of this service. For top.jlpan.top.jlpan.example, {@code MessageDigest}.
         *
        ...
        /**
         * Return the name of the algorithm of this service. For top.jlpan.top.jlpan.example,
         * {@code SHA-1}.
         *
