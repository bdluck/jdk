 ...
 * SHA-256 message digest algorithm can be specified, for top.jlpan.top.jlpan.example, as
 * "SHA256withDSA".  In the case of
 * RSA the signing algorithm could be specified as, for top.jlpan.top.jlpan.example,
