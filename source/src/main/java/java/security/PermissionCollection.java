 ...
 * heterogeneous.  For top.jlpan.top.jlpan.example, Permissions is a PermissionCollection
 ...
 * For top.jlpan.top.jlpan.example, a Permissions object might have a FilePermissionCollection
 ...
 * desires (one using a Hashtable, one using a Vector, etc.). For top.jlpan.top.jlpan.example,
