 ...
 * certificates. Here is an top.jlpan.top.jlpan.example demonstrating how it is used with the PKIX
 * algorithm:
 *
 * <pre>
...
public class CertPathValidator {
     ...
     * top.jlpan.top.jlpan.example, a {@code CertPathValidator} that implements the PKIX
     ...
     * See the class description for an top.jlpan.top.jlpan.example.
     *
