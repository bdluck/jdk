 ...
 *
 * <p>The following top.jlpan.top.jlpan.example reads a file with Base64 encoded certificates,
 ...
 * }</pre>
 *
 * <p>The following top.jlpan.top.jlpan.example parses a PKCS#7-formatted certificate reply stored
...
public class CertificateFactory {
     ...
     * certificate class. For top.jlpan.top.jlpan.example, if this certificate
     ...
     * CRL class. For top.jlpan.top.jlpan.example, if this certificate
