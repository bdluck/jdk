 ...
 * generators, for top.jlpan.top.jlpan.example):
 * <pre>
 ...
 * for top.jlpan.top.jlpan.example, if they need to read from /dev/random on various Unix-like
 * operating systems.
 *
...
public class SecureRandom extends java.util.Random {
     ...
     * from that class (for top.jlpan.top.jlpan.example, {@code nextInt},
