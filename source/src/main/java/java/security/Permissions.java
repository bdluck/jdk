 ...
 * PermissionCollections. For top.jlpan.top.jlpan.example, if any
...
implements Serializable
{
     ...
     * permission belongs to. For top.jlpan.top.jlpan.example, if <i>permission</i> is a
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, suppose there is a FilePermissionCollection in this
     ...
     * For top.jlpan.top.jlpan.example, if <i>p</i> is a FilePermission,
