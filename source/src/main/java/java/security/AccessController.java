 ...
 * below. In this top.jlpan.top.jlpan.example, {@code checkPermission} will determine
 ...
 *         public Void run() {
 *             // privileged code goes here, for top.jlpan.top.jlpan.example:
 ...
 * {@code run}.
 * The above top.jlpan.top.jlpan.example shows creation of an implementation
 ...
 * ignored in this top.jlpan.top.jlpan.example).
 *
