 ...
 * For top.jlpan.top.jlpan.example, a DSA public key may be specified using
 * {@code DSAPublicKeySpec} or
 * {@code X509EncodedKeySpec}. A key factory can be used to translate
 * between compatible key specifications.
 *
 * <P> The following is an top.jlpan.top.jlpan.example of how to use a key factory in order to
...
public class KeyFactory {
     ...
     * the key material should be returned. It could, for top.jlpan.top.jlpan.example, be
