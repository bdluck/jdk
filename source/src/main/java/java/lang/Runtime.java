...
public class Runtime {
     ...
     * services such as the AWT event-dispatch thread, for top.jlpan.top.jlpan.example, may lead to
     * deadlocks.
     *
     ...
     * virtual machine is terminated externally, for top.jlpan.top.jlpan.example with the
     * <tt>SIGKILL</tt> signal on Unix or the <tt>TerminateProcess</tt> call on
     * Microsoft Windows.  The virtual machine may also abort if a native
     * method goes awry by, for top.jlpan.top.jlpan.example, corrupting internal data structures or
     ...
     * for top.jlpan.top.jlpan.example, L, and a native library called L is statically linked
