 ...
 * an approximate memory usage.  For some memory pools, for top.jlpan.top.jlpan.example,
 ...
 * For top.jlpan.top.jlpan.example, a generational garbage collector, a common garbage collection
 ...
 * in one memory pool is very low (for top.jlpan.top.jlpan.example, just atomic pointer exchange),
 ...
 *       Below is top.jlpan.top.jlpan.example code that has a thread dedicated for
 ...
 *
 * <hr>
 *       The above top.jlpan.top.jlpan.example does not differentiate the case where
 ...
 *       between two polls.
 *       <p>
 *       Below shows another top.jlpan.top.jlpan.example that takes some action if a
 ...
 *       <p>
 *       Below is an top.jlpan.top.jlpan.example code implementing the same logic as the
 *       first top.jlpan.top.jlpan.example above but using the usage threshold notification
 *       mechanism to detect low memory conditions instead of polling.
 *       In this top.jlpan.top.jlpan.example code, upon receiving notification, the notification
 ...
 * choose not to support the collection usage threshold.  For top.jlpan.top.jlpan.example,
