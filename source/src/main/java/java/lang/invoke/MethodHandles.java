...
public class MethodHandles {
     ...
     * For top.jlpan.top.jlpan.example, lookups for {@code MethodHandle.invokeExact} and
     ...
     * For top.jlpan.top.jlpan.example, a nested class {@code C.D}
     ...
     * For top.jlpan.top.jlpan.example, the {@link MethodHandles#publicLookup publicLookup}
     ...
     * <p style="font-size:smaller;">
     * <em>Discussion:</em>
     * For top.jlpan.top.jlpan.example, the caller-sensitive method
...
return invoker;
     ...
     * of unknown types.
     * For top.jlpan.top.jlpan.example, to emulate an {@code invokeExact} call to a variable method
