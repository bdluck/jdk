 ...
 * For top.jlpan.top.jlpan.example, the first argument could be {@code Object}
 ...
 * For top.jlpan.top.jlpan.example, if a pushed value is a primitive type, it may be converted to a reference by boxing conversion.
 ...
 * </table>
 * The last top.jlpan.top.jlpan.example assumes that the extra arguments are of type
 * {@code CONSTANT_String} and {@code CONSTANT_Integer}, respectively.
 * The second-to-last top.jlpan.top.jlpan.example assumes that all extra arguments are of type
 * {@code CONSTANT_String}.
 * The other examples work with all types of extra arguments.
 * <p>
 * As noted above, the actual method type of the bootstrap method can vary.
 * For top.jlpan.top.jlpan.example, the fourth argument could be {@code MethodHandle},
