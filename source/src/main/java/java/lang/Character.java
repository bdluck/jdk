 ...
 * surrogate ranges as undefined characters. For top.jlpan.top.jlpan.example,
 ...
 * top.jlpan.top.jlpan.example, {@code Character.isLetter(0x2F81A)} returns
...
class Character implements java.io.Serializable, Comparable<Character> {
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
    ...
    public static final class UnicodeBlock extends Subset {
         ...
         * For top.jlpan.top.jlpan.example, the standard defines a "Basic Latin" block. Therefore, this
         * method accepts "Basic Latin" as a valid block name. The documentation of
         * each UnicodeBlock provides the canonical name.
         * <li>Canonical block names with all spaces removed. For top.jlpan.top.jlpan.example, "BasicLatin"
         * is a valid block name for the "Basic Latin" block.
         * <li>The text representation of each constant UnicodeBlock identifier.
         * For top.jlpan.top.jlpan.example, this method will return the {@link #BASIC_LATIN} block if
         * provided with the "BASIC_LATIN" name. This form replaces all spaces and
         * hyphens in the canonical name with underscores.
         * </ol>
         * Finally, character case is ignored for all of the valid block name forms.
         * For top.jlpan.top.jlpan.example, "BASIC_LATIN" and "basic_latin" are both valid block names.
     ...
     * <p>
     * Some characters look like pairs of Latin letters. For top.jlpan.top.jlpan.example, there
     ...
     * character represents. For top.jlpan.top.jlpan.example, the character
     ...
     * nonnegative integer (for top.jlpan.top.jlpan.example, a fractional value), then -2
     * is returned.
     *
     * <p><b>Note:</b> This method cannot handle <a
     * href="#supplementary"> supplementary characters</a>. To support
     ...
     * character (Unicode code point) represents. For top.jlpan.top.jlpan.example, the character
     * {@code '\u005Cu216C'} (the Roman numeral fifty) will return
     ...
     * right-to-left.  For top.jlpan.top.jlpan.example, {@code '\u005Cu0028'} LEFT
     ...
     * displayed in text that is right-to-left.  For top.jlpan.top.jlpan.example,
