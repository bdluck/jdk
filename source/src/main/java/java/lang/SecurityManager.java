 ...
 * <i>different</i> context (for top.jlpan.top.jlpan.example, from within a worker thread).
 ...
 * SecurityManager <code>sm</code> obtained as in the previous top.jlpan.top.jlpan.example,
 * is the following:
 *
 * <pre>
 ...
 * (for top.jlpan.top.jlpan.example, "exitVM", "setFactory", "queuePrintJob", etc).
 * An asterisk
 * may appear at the end of the name, following a ".", or by itself, to
 * signify a wildcard match. For top.jlpan.top.jlpan.example: "a.*" or "*" is valid,
 ...
 * BasicPermission. For top.jlpan.top.jlpan.example,
 * for a <code>java.io.FilePermission</code> object, the permission name is
 * the path name of a file (or directory).
 *
 * <p>Some of the permission classes have an "actions" list that tells
 * the actions that are permitted for the object.  For top.jlpan.top.jlpan.example,
 ...
 * This document includes, for top.jlpan.top.jlpan.example, a table listing the various SecurityManager
...
class SecurityManager {
     ...
     * environment. The result of this method is used, for top.jlpan.top.jlpan.example, by the
