...
public interface Instrumentation {
     ...
     *  Where order is not meaningful, for top.jlpan.top.jlpan.example the order of methods,
     ...
     * top.jlpan.top.jlpan.example in bytecode instrumentation)
     ...
     * returned by this function.
     * <P>
     * Primitive classes (for top.jlpan.top.jlpan.example, <code>java.lang.Integer.TYPE</code>)
     ...
     * behavior that is difficult to diagnose. For top.jlpan.top.jlpan.example, suppose there is a
     ...
     * by the bootstrap class loader. In this top.jlpan.top.jlpan.example an <code>IllegalAccessError</code>
     ...
     * For top.jlpan.top.jlpan.example, if we had:
     * <pre>
     ...
     * wrapper exists.  Thus, in the last top.jlpan.top.jlpan.example, even though
