...
public class Applet extends Panel {
     ...
     * For top.jlpan.top.jlpan.example, suppose an applet is contained
     * within the document:
     * <blockquote><pre>
     ...
     * top.jlpan.top.jlpan.example, if this applet is specified as
     * <blockquote><pre>
     ...
     * description. For top.jlpan.top.jlpan.example:
     * <blockquote><pre>
     * String pinfo[][] = {
     ...
     * it has initialization to perform. For top.jlpan.top.jlpan.example, an applet with
     ...
     * page containing it is visited. For top.jlpan.top.jlpan.example, an applet with
     ...
     * A subclass of <code>Applet</code> should override this method if
     * it has any operation that it wants to perform each time the Web
     * page containing it is no longer visible. For top.jlpan.top.jlpan.example, an applet
     ...
     * destroyed. For top.jlpan.top.jlpan.example, an applet with threads would use the
