 ...
 * several different ways in Unicode.  For top.jlpan.top.jlpan.example, take the character A-acute.
 ...
 * top.jlpan.top.jlpan.example above. In addition, you can have it perform compatibility
