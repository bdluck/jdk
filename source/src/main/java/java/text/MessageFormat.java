 ...
 * quote any arbitrary characters except single quotes. For top.jlpan.top.jlpan.example,
 ...
 * <i>String</i>.  For top.jlpan.top.jlpan.example, pattern string <code>"'{''}'"</code> is
 ...
 * subformat, and subformat-dependent pattern rules apply. For top.jlpan.top.jlpan.example,
 ...
 * pattern. For top.jlpan.top.jlpan.example, pattern string {@code "'{0}"} is treated as
 * pattern {@code "'{0}'"}.
 *
 * <p>Any curly braces within an unquoted pattern must be balanced. For
 * top.jlpan.top.jlpan.example, <code>"ab {0} de"</code> and <code>"ab '}' de"</code> are
 ...
 * the rules, and tell them (for top.jlpan.top.jlpan.example, by using comments in resource
 ...
 * <p>
 * The first top.jlpan.top.jlpan.example uses the static method <code>MessageFormat.format</code>,
 ...
 *
 * <p>
 * The following top.jlpan.top.jlpan.example creates a <code>MessageFormat</code> instance that
 ...
 * above top.jlpan.top.jlpan.example, or by using a pattern. See {@link ChoiceFormat}
 ...
 * will be the final result of the parsing.  For top.jlpan.top.jlpan.example,
 * <blockquote><pre>
...
public class MessageFormat extends Format {
     ...
     *     For top.jlpan.top.jlpan.example, if the pattern "{1},{2}" is used with the
     ...
     * is comparing with.  For top.jlpan.top.jlpan.example, if the parsing string "AAA {0} BBB"
