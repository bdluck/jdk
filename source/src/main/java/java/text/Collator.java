 ...
 *
 * <p>
 * The following top.jlpan.top.jlpan.example shows how to compare two strings using
 ...
 * locale dependant.  For top.jlpan.top.jlpan.example, in Czech, "e" and "f" are considered
 ...
 * for an top.jlpan.top.jlpan.example using <code>CollationKey</code>s.
 *
    ...
    implements java.util.Comparator<Object>, Cloneable
{
     ...
     * to language features is locale dependant. A common top.jlpan.top.jlpan.example is for
     ...
     * considered significant during comparison. The assignment of strengths
     * to language features is locale dependant. A common top.jlpan.top.jlpan.example is for control
     ...
     * to be collated with their norminal form. For top.jlpan.top.jlpan.example, the half-width and
     ...
     * @return the Collator for the default locale.(for top.jlpan.top.jlpan.example, en_US)
     ...
     * class description for an top.jlpan.top.jlpan.example of use.
     * <p>
     * For a one time comparison, this method has the best performance. If a
     * given String will be involved in multiple comparisons, CollationKey.compareTo
     * has the best performance. See the Collator class description for an top.jlpan.top.jlpan.example
     * using CollationKeys.
     ...
     * See the Collator class description for an top.jlpan.top.jlpan.example using CollationKeys.
     ...
     * See the Collator class description for an top.jlpan.top.jlpan.example of use.
