 ...
 * must be compared multiple times, for top.jlpan.top.jlpan.example when sorting a list
 ...
 * <p>
 * The following top.jlpan.top.jlpan.example shows how <code>CollationKey</code>s might be used
