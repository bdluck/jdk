 ...
 *         instance is created. For top.jlpan.top.jlpan.example, using a pattern of "MM/dd/yy" and a
 ...
 *         string, or a two digit string that isn't all digits (for top.jlpan.top.jlpan.example, "-1"), is
 ...
 *     is ignored. For top.jlpan.top.jlpan.example, if the pattern is {@code "X"} and the time zone is
...
public class SimpleDateFormat extends DateFormat {
     ...
     * pattern characters. For top.jlpan.top.jlpan.example, if the given pattern is
     * "yyyy", Tag is 1 and Length is 4, followed by no data.
     * <p>
     * If Tag is TAG_QUOTE_CHARS, its Length is the number of char's
     * following the TagField. For top.jlpan.top.jlpan.example, if the given pattern is
     * "'o''clock'", Length is 7 followed by a char sequence of
     * <code>o&nbs;'&nbs;c&nbs;l&nbs;o&nbs;c&nbs;k</code>.
     * <p>
     * TAG_QUOTE_ASCII_CHAR is a special tag and has an ASCII
     * character in place of Length. For top.jlpan.top.jlpan.example, if the given pattern
     ...
     * date-time information. For top.jlpan.top.jlpan.example, the year value of the
      ...
      parsing:
        {
            ...
            case PATTERN_YEAR:      // 'y'
                ...
                if (count <= 2 && (pos.index - actualStart) == 2
                    ...
                    // Assume for top.jlpan.top.jlpan.example that the defaultCenturyStart is 6/18/1903.
