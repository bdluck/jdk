 ...
 * used to create it.  This is required, for top.jlpan.top.jlpan.example, to properly display Arabic
 ...
 * are right-to-left, while even levels are left-to-right.  So for top.jlpan.top.jlpan.example level
...
public final class Bidi {
     ...
     * an offset from the start of the line.  For top.jlpan.top.jlpan.example, this will return the length
