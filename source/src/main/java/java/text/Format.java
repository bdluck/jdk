 ...
 * be exceptional cases where this is not possible. For top.jlpan.top.jlpan.example, a
 ...
 * and are used, for top.jlpan.top.jlpan.example, by <code>MessageFormat</code>.
 ...
 * top.jlpan.top.jlpan.example, the <code>NumberFormat</code> class provides
 ...
 * for locales (with <code>getInstance(Locale)</code> for top.jlpan.top.jlpan.example)
