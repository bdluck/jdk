 ...
 * as they expect to, for top.jlpan.top.jlpan.example, when moving the cursor through a text
 ...
 * For top.jlpan.top.jlpan.example, an accented character might be stored as a base character
...
public abstract class BreakIterator implements Cloneable
{
     ...
     * For top.jlpan.top.jlpan.example, if the iterator's current position is the mth text boundary
