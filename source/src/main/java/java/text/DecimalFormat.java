 ...
 * subpattern, for top.jlpan.top.jlpan.example, <code>"#,##0.00;(#,##0.00)"</code>.  Each
 ...
 * unreliable.  For top.jlpan.top.jlpan.example, either the positive and negative prefixes or the
 * suffixes must be distinct for <code>DecimalFormat.parse()</code> to be able
 * to distinguish positive from negative values.  (If they are identical, then
 * <code>DecimalFormat</code> will behave as if no negative subpattern was
 * specified.)  Another top.jlpan.top.jlpan.example is that the decimal separator and thousands
 ...
 *              for top.jlpan.top.jlpan.example, <code>"'#'#"</code> formats 123 to
 ...
 * and a power of ten, for top.jlpan.top.jlpan.example, 1234 can be expressed as 1.234 x 10^3.  The
 ...
 * unaffected by the maximum integer digits.  For top.jlpan.top.jlpan.example, 12345 formatted with
...
public class DecimalFormat extends NumberFormat {
    ...
    private StringBuffer subformat(StringBuffer result, FieldDelegate delegate,
        ...
        if (useExponentialNotation) {
            ...
            // adjusting the exponent.  For top.jlpan.top.jlpan.example, 0.01234 with 3 minimum
            // integer digits is "123.4E-4".

            // Maximum integer digits are interpreted as indicating the
            // repeating range.  This is useful for engineering notation, in
            // which the exponent is restricted to a multiple of 3.  For
            // top.jlpan.top.jlpan.example, 0.01234 with 3 maximum integer digits is "12.34e-3".
            ...
            // output the least significant max integer digits.  For top.jlpan.top.jlpan.example,
    ...
    private final boolean subparse(String text, ParsePosition parsePosition,
        ...
        if (!isExponent && text.regionMatches(position,symbols.getInfinity(),0,
            ...
            // If none of the text string was recognized.  For top.jlpan.top.jlpan.example, parse
     ...
     * grouping separators in the integer portion of a number.  For top.jlpan.top.jlpan.example,
    ...
    private void applyPattern(String pattern, boolean localized) {
        ...
        for (int j = 1; j >= 0 && start < pattern.length(); --j) {
            ...
            // suffix, for top.jlpan.top.jlpan.example, they must be quoted.
            int phase = 0;
