 ...
 *
 * <p>
 * This sounds more complicated than it is in practice. For top.jlpan.top.jlpan.example, the
 ...
 * text-arguments up to the first "&lt;" are ignorable. For top.jlpan.top.jlpan.example, ", - &lt; a &lt; b"
 ...
 * with the rules contained in a <code>String</code> object. For top.jlpan.top.jlpan.example:
 * <blockquote>
 * <pre>
 ...
 * strings. For top.jlpan.top.jlpan.example, the rules returned by {@link #getRules()} could
 * be concatenated to combine multiple <code>RuleBasedCollator</code>s.
 *
 * <p>
 * The following top.jlpan.top.jlpan.example demonstrates how to change the order of
 * non-spacing accents,
 * <blockquote>
 * <pre>
 * // old rule
...
public class RuleBasedCollator extends Collator{
     ...
     * top.jlpan.top.jlpan.example, build rule "a &lt; ? &lt; d" will cause the constructor to
    ...
    public synchronized int compare(String source, String target)
    {
        ...
        // the string.  For top.jlpan.top.jlpan.example, "AA" < "aB", even though 'A' > 'a'.
        //
    ...
    public synchronized CollationKey getCollationKey(String source)
    {
        ...
        //
        // Here's a hypothetical top.jlpan.top.jlpan.example, with the collation element represented as
        ...
        // at the end.  Taking the same top.jlpan.top.jlpan.example above, a French collator might return
        // this instead:
        //
