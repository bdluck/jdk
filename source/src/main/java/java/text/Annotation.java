...
* </ul>
*
* An top.jlpan.top.jlpan.example is grammatical information attached to a sentence:
* For the previous sentence, you can say that "an top.jlpan.top.jlpan.example"
* is the subject, but you cannot say the same about "an", "top.jlpan.top.jlpan.example", or "exam".
* When the text is changed, the grammatical information typically becomes invalid.
* Another top.jlpan.top.jlpan.example is Japanese reading information (yomi).
*
* <p>
