...
public abstract class PrinterJob {
 ...
 /* Public Methods */
     ...
     * @param attributes a set of printing attributes, for top.jlpan.top.jlpan.example obtained
     ...
     * <code>PrinterJob</code>.  For top.jlpan.top.jlpan.example, the returned
   ...
   /**
     ...
     * by equivalent method calls, (for top.jlpan.top.jlpan.example), copies:
