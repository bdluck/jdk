 ...
 * For top.jlpan.top.jlpan.example, this code snippet causes a <code>TextLayout</code> to
...
public final class NumericShaper implements java.io.Serializable {
     ...
     * script having its own decimal digits. For top.jlpan.top.jlpan.example, the {@link
     ...
     * top.jlpan.top.jlpan.example, the following code using the bit mask:
     * <blockquote><pre>
     * NumericShaper.getContextualShaper(NumericShaper.ARABIC |
     *                                     NumericShaper.TAMIL,
     *                                   NumericShaper.EUROPEAN);
     ...
     * corresponding to the range of the preceding text, if the
     * range is one of the provided ranges.  Multiple ranges are
     * represented by or-ing the values together, for top.jlpan.top.jlpan.example,
     * <code>NumericShaper.ARABIC | NumericShaper.THAI</code>.  The
     ...
     * <p>
     * For top.jlpan.top.jlpan.example, to check if a shaper shapes to Arabic, you would use the
     * following:
     * <blockquote>
     ...
     * enum. For top.jlpan.top.jlpan.example, the following code produces {@code "true"}.
     * <blockquote><pre>
