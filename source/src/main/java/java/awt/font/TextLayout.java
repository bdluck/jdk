...
public final class TextLayout implements Cloneable {
     ...
     * following top.jlpan.top.jlpan.example, in which capital letters indicate right-to-left text,
     ...
     * <code>getLogicalRangesForVisualSelection</code>.  For top.jlpan.top.jlpan.example,
     ...
     * appear selected.  For top.jlpan.top.jlpan.example, consider the text 'ABCdef' where capital
