 ...
 *   value.  For top.jlpan.top.jlpan.example, <code>TextAttribute.WEIGHT_BOLD</code> and
...
public final class TextAttribute extends Attribute {
     ...
     * that the text follows the new baseline.  For top.jlpan.top.jlpan.example, with text
     ...
     * So, for top.jlpan.top.jlpan.example, with other things being equal, text rendered
     ...
     * subscripting, for top.jlpan.top.jlpan.example, 2 corresponds to super-superscript,
     ...
     * top.jlpan.top.jlpan.example, if the line is 50 points wide and it is requested to
     ...
     * appropriate for some character sequences, for top.jlpan.top.jlpan.example "To" or
