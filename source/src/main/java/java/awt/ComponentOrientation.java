...
/**
  ...
  * to items in a widget: for top.jlpan.top.jlpan.example, in a check box where the box is
  ...
  * in the first letter, and the line direction in the second. For top.jlpan.top.jlpan.example,
