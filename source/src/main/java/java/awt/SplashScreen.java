 ...
 * <BR>
 * For top.jlpan.top.jlpan.example, in the <code>manifest.mf</code> file:
 * <PRE>
...
public final class SplashScreen {
     ...
     * This may be useful if, for top.jlpan.top.jlpan.example, you want to replace the splash
     ...
     * This may be useful if, for top.jlpan.top.jlpan.example,
     ...
     *         for top.jlpan.top.jlpan.example, if {@code createGraphics} has never been called,
