...
public class Container extends Component {
     ...
     * (such as Frame for top.jlpan.top.jlpan.example).
     */
    public Container() {
    }
     ...
     * <p>
     * A <code>Frame</code> object, for top.jlpan.top.jlpan.example, has a top inset that
     ...
     * remove, for top.jlpan.top.jlpan.example, if newParent and current parent are the same it just changes
     ...
     * be required. For top.jlpan.top.jlpan.example, if new container and old containers are the same we don't need to
     ...
     * top.jlpan.top.jlpan.example, the <code>BorderLayout</code> class defines five
     ...
     * top.jlpan.top.jlpan.example, ContainerOrderFocusTraversalPolicy supports implicit down-cycle
     * traversal.
     * <p>
     ...
     * restrictions, however. For top.jlpan.top.jlpan.example, ContainerOrderFocusTraversalPolicy
