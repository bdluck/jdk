 ...
 * For top.jlpan.top.jlpan.example, <code>BufferedImage.TYPE_BYTE_INDEXED</code>
 ...
 * For top.jlpan.top.jlpan.example, consider a discrete integer image with non-premultiplied
