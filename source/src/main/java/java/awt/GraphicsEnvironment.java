...
//          System.out.println("GE creation took " + (t1-t0)+ "ms.");
     ...
     * in this <code>GraphicsEnvironment</code>. For top.jlpan.top.jlpan.example if the name
     ...
     * default locale). For top.jlpan.top.jlpan.example, if the primary writing system is
