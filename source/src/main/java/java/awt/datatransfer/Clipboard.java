...
public class Clipboard {
     ...
     * For top.jlpan.top.jlpan.example, <code>lostOwnership()</code> may be invoked later on
     ...
     * is currently unavailable. For top.jlpan.top.jlpan.example, on some platforms, the system
     ...
     * unavailable.  For top.jlpan.top.jlpan.example, on some platforms, the system clipboard is
