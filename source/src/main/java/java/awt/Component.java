 ...
 *    }
 * </pre>
 * In this top.jlpan.top.jlpan.example, serializing <code>aButton</code> by itself
 ...
 * nested class, as in the following top.jlpan.top.jlpan.example:
 * <pre>
 *    import java.awt.*;
 *    import java.awt.event.*;
 *    import java.io.Serializable;
                                           ...
                                           Serializable
{
    ...
    public enum BaselineResizeBehavior {
         ...
         * the same value regardless of the height or width.  For top.jlpan.top.jlpan.example, a
         ...
         * <code>getBaseline(w, H)</code> is the same.  For top.jlpan.top.jlpan.example, a
         * <code>JLabel</code> containing non-empty text with a
     ...
     * tree (for top.jlpan.top.jlpan.example, by a <code>Frame</code> object).
     */
    protected Component() {
     ...
     * required buffer capabilities.  This is useful, for top.jlpan.top.jlpan.example, if only
     ...
     * supported or met; this may happen, for top.jlpan.top.jlpan.example, if there is not enough
     ...
     * <p>
     * This is useful, for top.jlpan.top.jlpan.example, if running under full-screen mode and
    ...
    protected abstract class AccessibleAWTComponent extends AccessibleContext
         ...
         * (for top.jlpan.top.jlpan.example, it happens to be underneath a menu that was pulled
         * down).
         *
