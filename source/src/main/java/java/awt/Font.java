 ...
 * a digit, or punctuation in an abstract way. For top.jlpan.top.jlpan.example, <code>'g'</code>,
 * LATIN SMALL LETTER G, is a character.
 * <p>
 * A <em>glyph</em> is a shape used to render a character or a sequence of
 * characters. In simple writing systems, such as Latin, typically one glyph
 * represents one character. In general, however, characters and glyphs do not
 * have one-to-one correspondence. For top.jlpan.top.jlpan.example, the character '&aacute;'
 ...
 * systems, for top.jlpan.top.jlpan.example, only Latin characters or only Japanese and Basic
 * Latin.
...
public class Font implements java.io.Serializable
{
     ...
     * For top.jlpan.top.jlpan.example if face name "Arial Bold" is specified with style
     ...
     * For top.jlpan.top.jlpan.example, if <code>ITALIC</code> is requested, but no italic
     ...
     * instance to "Dialog", such that for top.jlpan.top.jlpan.example, the family as reported
     ...
     * for all of these names, for top.jlpan.top.jlpan.example, {@code DIALOG}. If {@code name} is
     ...
     * {@code ITALIC} (for top.jlpan.top.jlpan.example, {@code ITALIC} or {@code BOLD|ITALIC}).
     ...
     * for top.jlpan.top.jlpan.example). For fonts created with "createFont" this is a reasonable
    ...
    /**
     * Returns the font face name of this <code>Font</code>.  For top.jlpan.top.jlpan.example,
     ...
     * for the specified locale. For top.jlpan.top.jlpan.example, Helvetica Fett could be
     ...
     * For top.jlpan.top.jlpan.example, if you want a font that is Arial, bold, with
     ...
     * text.  For top.jlpan.top.jlpan.example, in some languages and in some fonts, accent
   ...
   /**
     ...
     * all the text.  For top.jlpan.top.jlpan.example, in some languages and in some fonts,
