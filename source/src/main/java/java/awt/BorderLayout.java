 ...
 * five constants, for top.jlpan.top.jlpan.example:
 * <pre>
 *    Panel p = new Panel();
 ...
 * For top.jlpan.top.jlpan.example, if you add components using both the <code>NORTH</code>
 ...
 * <p>
 * Here is an top.jlpan.top.jlpan.example of five buttons in an applet laid out using
