 ...
 * </ul>
 * <p>
 * For top.jlpan.top.jlpan.example, the following picture shows an applet using the flow
...
public class FlowLayout implements LayoutManager, java.io.Serializable {
     ...
     * orientation, for top.jlpan.top.jlpan.example, to the left in left-to-right orientations.
     *
     ...
     * orientation, for top.jlpan.top.jlpan.example, to the right in left-to-right orientations.
     *
     * @see     java.awt.Component#getComponentOrientation
     * @see     java.awt.ComponentOrientation
     * @since   1.2
