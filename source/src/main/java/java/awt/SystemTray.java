...
public class SystemTray {
     ...
     * SystemTray top.jlpan.top.jlpan.example} for an top.jlpan.top.jlpan.example of how to do this.
     *
     ...
     *        from) the system tray.<br> For top.jlpan.top.jlpan.example, this property is changed
