 ...
 *
 * <p>
 * For top.jlpan.top.jlpan.example, pressing the Shift key will cause a KEY_PRESSED event
 ...
 * platform and keyboard layout. For top.jlpan.top.jlpan.example, the key that generates VK_Q
 ...
 * <li>Not all characters have a keycode associated with them.  For top.jlpan.top.jlpan.example,
 ...
 * and modifiers. For top.jlpan.top.jlpan.example, for Japanese Windows keyboards, VK_ALL_CANDIDATES
...
public class KeyEvent extends InputEvent {
     ...
     * For top.jlpan.top.jlpan.example, the <code>KEY_TYPED</code> event for shift + "a"
