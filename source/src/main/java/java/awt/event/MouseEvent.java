 ...
 *<p>
 * For top.jlpan.top.jlpan.example, if a {@code MouseListener} has been added to a component, or
 ...
 * <P>
 * For top.jlpan.top.jlpan.example, if the first mouse button is pressed, events are sent in the
 * following order:
 * <PRE>
...
public class MouseEvent extends InputEvent {
   ...
   */
     ...
     * For top.jlpan.top.jlpan.example, for a mouse with two buttons this field may contain the following values:
     * <ul>
     * <li> 0 ({@code NOBUTTON})
     * <li> 1 ({@code BUTTON1})
     * <li> 2 ({@code BUTTON2})
