 ...
 * default manner.  For top.jlpan.top.jlpan.example, consuming mousePressed events
...
public abstract class InputEvent extends ComponentEvent {
     ...
     *                     buttons (for top.jlpan.top.jlpan.example, shift, ctrl, alt, and meta) that
     ...
     * the event occurred.
     * <P>
     * For top.jlpan.top.jlpan.example, if the user presses <b>button 1</b> followed by
     ...
     * For top.jlpan.top.jlpan.example, the appropriate way to check that SHIFT and BUTTON1 are
