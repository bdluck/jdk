 ...
 * <p>
 * Each scroll bar in this top.jlpan.top.jlpan.example could be created with
 ...
 * top.jlpan.top.jlpan.example, if a scroll bar is used for scrolling through text, the
 * width of the "bubble" (also called the "thumb" or "scroll box")
 * can be used to represent the amount of text that is visible.
 * Here is an top.jlpan.top.jlpan.example of a scroll bar that represents a range:
 * <p>
 ...
 * style="float:center; margin: 7px 10px;">
 * <p>
 * The value range represented by the bubble in this top.jlpan.top.jlpan.example
 * is the <em>visible amount</em>. The horizontal scroll bar
 * in this top.jlpan.top.jlpan.example could be created with code like the following:
 *
 * <hr><blockquote><pre>
 ...
 * In the previous top.jlpan.top.jlpan.example, because the <code>maximum</code> is
 ...
 * making a gesture with the mouse. For top.jlpan.top.jlpan.example, the user can
