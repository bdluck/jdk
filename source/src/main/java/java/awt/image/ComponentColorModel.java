 ...
 * name of the color space type. For top.jlpan.top.jlpan.example, for <CODE>TYPE_RGB</CODE>,
 ...
 * are used.  (As an top.jlpan.top.jlpan.example, specifying an alpha component as a signed
