 ...
 * uses an array to produce pixel values for an Image.  Here is an top.jlpan.top.jlpan.example
 ...
 * top.jlpan.top.jlpan.example showing how to set up the animation source and signal changes
