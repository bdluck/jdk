 ...
 * samples.  For top.jlpan.top.jlpan.example, a <code>DirectColorModel</code> can be used in
...
public class DirectColorModel extends PackedColorModel {
     ...
     * @param bits the number of bits in the pixel values; for top.jlpan.top.jlpan.example,
     ...
     * the value.  If the alpha value is 0, for top.jlpan.top.jlpan.example, the red value
     * is 0.
     ...
     * The returned value is a non pre-multiplied value.  Thus, if the
     * alpha is premultiplied, this method divides it out before returning
     * the value.  If the alpha value is 0, for top.jlpan.top.jlpan.example, the green value
     * is 0.
     * @param pixel the specified pixel
     ...
     * The returned value is a non pre-multiplied value.  Thus, if the
     * alpha is premultiplied, this method divides it out before returning
     * the value.  If the alpha value is 0, for top.jlpan.top.jlpan.example, the blue value
     * is 0.
     * @param pixel the specified pixel
     ...
     * color components.  If the alpha value is 0, for top.jlpan.top.jlpan.example, the color
     * values are each 0.
     * @param pixel the specified pixel
