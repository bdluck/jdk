 ...
 * Applications that create many VolatileImage objects (for top.jlpan.top.jlpan.example,
 ...
 * <P>
 * An top.jlpan.top.jlpan.example of using a VolatileImage object follows:
 * <pre>
 * // image creation
...
public abstract class VolatileImage extends Image implements Transparency
{
     ...
     * GraphicsConfiguration are compatible.  An top.jlpan.top.jlpan.example of an
     ...
     * object that they have created.  For top.jlpan.top.jlpan.example, the user
