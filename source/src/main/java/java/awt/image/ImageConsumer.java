...
public interface ImageConsumer {
     ...
     * top.jlpan.top.jlpan.example of an image format which does not meet this criterion
     ...
     * image data will be delivered.  An top.jlpan.top.jlpan.example of an image type which
