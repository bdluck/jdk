 ...
 *  particular type in an image.  For top.jlpan.top.jlpan.example, a pixel might contain
 ...
 *  can be stored in various formats.  For top.jlpan.top.jlpan.example, all samples from
