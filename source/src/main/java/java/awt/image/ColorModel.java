 ...
 * (for top.jlpan.top.jlpan.example, red, green, and blue) and an alpha component.
 ...
 * components varies by subclass.  For top.jlpan.top.jlpan.example, there is not necessarily
...
public abstract class ColorModel implements Transparency{
     ...
     * provided by the particular AWT implementations (for top.jlpan.top.jlpan.example,
     ...
     * from pixel values.  For top.jlpan.top.jlpan.example, for an
     ...
     * of the color space type. For top.jlpan.top.jlpan.example, for TYPE_RGB, index 0
     ...
     * pre-multiplied value.  For top.jlpan.top.jlpan.example, if the
     ...
     * pre-multiplied value.  For top.jlpan.top.jlpan.example, if the alpha is premultiplied,
     ...
     * value, for top.jlpan.top.jlpan.example, if the alpha is premultiplied, this method
     ...
     * pre-multiplied format. For top.jlpan.top.jlpan.example, if the alpha is premultiplied,
     ...
     * pre-multiplied value.  For top.jlpan.top.jlpan.example, if alpha is premultiplied,
     * this method divides it out before returning
     * the value.  If the alpha value is 0, the red value is 0.
     ...
     * For top.jlpan.top.jlpan.example, this method can be used to retrieve the
