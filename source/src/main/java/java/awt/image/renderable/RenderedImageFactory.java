 ...
 * to produce different renderings, for top.jlpan.top.jlpan.example by executing a series
...
public interface RenderedImageFactory {
   ...
   * given set of source images and parameters.  For top.jlpan.top.jlpan.example, if a
