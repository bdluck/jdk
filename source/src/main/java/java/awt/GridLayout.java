 ...
 * For top.jlpan.top.jlpan.example, the following is an applet that lays out six buttons
 ...
 * and left-to-right, the above top.jlpan.top.jlpan.example produces the output shown in Figure 1.
 * If the container's <code>ComponentOrientation</code> property is horizontal
 * and right-to-left, the top.jlpan.top.jlpan.example produces the output shown in Figure 2.
 *
 ...
 * top.jlpan.top.jlpan.example, if three rows and two columns have been specified
