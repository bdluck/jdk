 ...
 * For top.jlpan.top.jlpan.example, the default <code>Stroke</code> is a
 ...
 * with the desired <code>Shape</code>.  For top.jlpan.top.jlpan.example, when filling a
 * rectangle:
 * <pre>
 ...
 * called with the desired <code>Shape</code>.  For top.jlpan.top.jlpan.example, when drawing a
 * rectangle:
 * <pre>
