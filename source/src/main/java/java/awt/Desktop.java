 ...
 * top.jlpan.top.jlpan.example, the {@code "sxi"} file extension is typically registered
...
public class Desktop {
     ...
     * not have a registered application for the action.  For top.jlpan.top.jlpan.example,
