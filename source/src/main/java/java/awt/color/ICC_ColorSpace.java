...
public class ICC_ColorSpace extends ColorSpace {
    ...
    */
     ...
     * values of the PCS are relative to D50.  For top.jlpan.top.jlpan.example, white in the PCS
     ...
     * top.jlpan.top.jlpan.example, displaying the RGB color (1.0, 1.0, 1.0) on an sRGB device
