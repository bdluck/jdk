 ...
 * <p>
 * The following code top.jlpan.top.jlpan.example creates a set of check boxes in
 * a grid layout:
 *
 * <hr><blockquote><pre>
 ...
 * created by this code top.jlpan.top.jlpan.example:
 * <p>
 ...
 * other two are in the "off" state. In this top.jlpan.top.jlpan.example, which uses the
