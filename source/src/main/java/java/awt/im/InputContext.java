...
public class InputContext {
     ...
     *
     * <p>
     * A text editing component may call this method, for top.jlpan.top.jlpan.example, when
     ...
     * determine whether this operation is supported. For top.jlpan.top.jlpan.example, an input method may enable
     ...
     * for top.jlpan.top.jlpan.example, when the user moves the insertion point within the text
