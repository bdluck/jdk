...
public interface InputMethodDescriptor {
     ...
     * For top.jlpan.top.jlpan.example, if a Japanese input method also has a pass-through
     ...
     * is inoperable, for top.jlpan.top.jlpan.example, because of incomplete installation.
     */
    Locale[] getAvailableLocales() throws AWTException;

    /**
     * Returns whether the list of available locales can change
     * at runtime. This may be the case, for top.jlpan.top.jlpan.example, for adapters
