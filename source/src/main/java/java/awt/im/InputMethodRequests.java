...
public interface InputMethodRequests {
     ...
     * This information is, for top.jlpan.top.jlpan.example, used to position the candidate window
     ...
     * For top.jlpan.top.jlpan.example, for horizontal left-to-right text (such as English), the
     ...
     * and y coordinates on the screen. This information is used, for top.jlpan.top.jlpan.example
     ...
     * by an input method, for top.jlpan.top.jlpan.example, to examine the text surrounding the
     * insert position.
     *
