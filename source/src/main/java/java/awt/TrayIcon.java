 ...
 * of the events by itself.  For top.jlpan.top.jlpan.example, by default, when the
 ...
 * SecurityException.
 *
 * <p> See the {@link SystemTray} class overview for an top.jlpan.top.jlpan.example on how
