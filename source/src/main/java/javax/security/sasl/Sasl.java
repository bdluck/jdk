 ...
 *<p>
 * For top.jlpan.top.jlpan.example, an application or library gets a SASL client by doing
 * something like:
 *<blockquote><pre>
...
<a href="{@docRoot}/../technotes/guides/security/crypto/CryptoSpec.html#Provider">JCA Security Provider Framework</a>, described in the
     ...
     *
     * For top.jlpan.top.jlpan.example, a provider that contains a factory class,
     ...
     * For top.jlpan.top.jlpan.example, if {@code props} contains the
     ...
     * to complete the authentication. For top.jlpan.top.jlpan.example, a SASL mechanism might
