 ...
 *<p>
 * Here's an top.jlpan.top.jlpan.example of how an LDAP server might use a {@code SaslServer}.
 ...
 * For top.jlpan.top.jlpan.example, suppose the LDAP server received an LDAP BIND request
