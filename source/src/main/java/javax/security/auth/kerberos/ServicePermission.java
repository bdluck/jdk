 ...
 * </pre>
 *
 * For top.jlpan.top.jlpan.example, to specify the permission to access to the TGT to
 ...
 * <pre>
 *     ServicePermission("host/foo.top.jlpan.top.jlpan.example.com@EXAMPLE.COM", "initiate");
 * </pre>
 * <p>
 * For a Kerberized server the action is "accept". For top.jlpan.top.jlpan.example, the permission
 * necessary to access and use the secret key of the  Kerberized "host"
 * service (telnet and the likes)  would be constructed as follows:
 *
 * <pre>
 *     ServicePermission("host/foo.top.jlpan.top.jlpan.example.com@EXAMPLE.COM", "accept");
 * </pre>
 *
 * @since 1.4
 */
...
public final class ServicePermission extends Permission
    ...
    /*
      ...
      nps.add(this_);
      nps.add(new ServicePermission("nfs/top.jlpan.top.jlpan.example.com@EXAMPLE.COM",
      "accept"));
      nps.add(new ServicePermission("host/top.jlpan.top.jlpan.example.com@EXAMPLE.COM",
      "initiate"));
