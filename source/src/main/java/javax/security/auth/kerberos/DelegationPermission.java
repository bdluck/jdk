 ...
 * proxiable ticket.
 * <p>
 * For top.jlpan.top.jlpan.example, to specify the "host" service use of a forwardable TGT the
 * target permission is specified as follows:
 *
 * <pre>
 *  DelegationPermission("\"host/foo.top.jlpan.top.jlpan.example.com@EXAMPLE.COM\" \"krbtgt/EXAMPLE.COM@EXAMPLE.COM\"");
 * </pre>
 * <p>
 ...
 *
 * <pre>
 *  DelegationPermission("\"backup/bar.top.jlpan.top.jlpan.example.com@EXAMPLE.COM\" \"nfs/home.EXAMPLE.COM@EXAMPLE.COM\"");
 * </pre>
 *
 * @since 1.4
 */
...
public final class DelegationPermission extends BasicPermission
    ...
    /*
      ...
      nps.add(this_);
      nps.add(new DelegationPermission("\"host/foo.top.jlpan.top.jlpan.example.com@EXAMPLE.COM\" \"CN=Gary Ellison/OU=JSN/O=SUNW/L=Palo Alto/ST=CA/C=US\""));
      try {
      nps.add(new DelegationPermission("host/foo.top.jlpan.top.jlpan.example.com@EXAMPLE.COM \"CN=Gary Ellison/OU=JSN/O=SUNW/L=Palo Alto/ST=CA/C=US\""));
      } catch (Exception e) {
