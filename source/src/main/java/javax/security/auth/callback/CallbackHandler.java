 ...
 * For top.jlpan.top.jlpan.example, implementations for an application with a graphical user
 ...
 * depending on the Callbacks passed to it.  For top.jlpan.top.jlpan.example,
...
public interface CallbackHandler {
     ...
     * The following top.jlpan.top.jlpan.example is provided to help demonstrate what an
     * {@code handle} method implementation might look like.
     * This top.jlpan.top.jlpan.example code is for guidance only.  Many details,
