 ...
 * Note that this top.jlpan.top.jlpan.example only represents the default syntax for the
 ...
 * For top.jlpan.top.jlpan.example, a {@code LoginModule} may define options to support
 ...
 *
 * <p> The following represents an top.jlpan.top.jlpan.example {@code Configuration} entry
...
public abstract class Configuration {
     ...
     * For top.jlpan.top.jlpan.example, if this Configuration object stores its entries in a file,
