 ...
 * used to prompt for usernames and passwords, for top.jlpan.top.jlpan.example.
 ...
 * and control the behavior within it.  For top.jlpan.top.jlpan.example, a
 ...
 * the actual authentication (prompt for and verify a password for top.jlpan.top.jlpan.example)
...
public interface LoginModule {
     ...
     *                  passwords, for top.jlpan.top.jlpan.example). <p>
     *
     ...
     * a {@code Subject}.  For top.jlpan.top.jlpan.example, it may prompt for
