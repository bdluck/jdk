 ...
 * </pre>
 *
 * For top.jlpan.top.jlpan.example, the following permission grants access to the
 * com.sun.PrivateCredential owned by Subjects which have
 * a com.sun.Principal with the name, "duke".  Note that although
 * this top.jlpan.top.jlpan.example, as well as all the examples below, do not contain
 ...
 * For top.jlpan.top.jlpan.example, the following grants access to the
...
public final class PrivateCredentialPermission extends Permission {
     ...
     * For top.jlpan.top.jlpan.example, array[0][0] corresponds to the class name of
     ...
     *          target name.  For top.jlpan.top.jlpan.example:
     * <pre>
