 ...
 * less direct state changes.  For top.jlpan.top.jlpan.example, if <code>{@link #start()}</code> is called
...
public interface DataLine extends Line {
     ...
     * In some cases, not all queued data can be discarded.  For top.jlpan.top.jlpan.example, a
     ...
     * The level of precision is not guaranteed.  For top.jlpan.top.jlpan.example, an implementation
    ...
    public static class Info extends Line.Info {
         ...
         * For top.jlpan.top.jlpan.example, a multi-channel device supporting up to
