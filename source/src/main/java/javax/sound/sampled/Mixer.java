 ...
 * a mixer might provide a set of controls that are global to the mixer.  For top.jlpan.top.jlpan.example,
...
public interface Mixer extends Line {
     ...
     * the provided <code>Line.Info</code> object.  For top.jlpan.top.jlpan.example, if the info
