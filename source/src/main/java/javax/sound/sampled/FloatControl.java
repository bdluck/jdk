...
public abstract class FloatControl extends Control {
    ...
    public static class Type extends Control.Type {
         ...
         * A line can have more than one gain control.  For top.jlpan.top.jlpan.example, a mixer (which is
         ...
         * <code>AudioFormat</code> object.  For top.jlpan.top.jlpan.example, if the natural rate
         ...
         * change in the sound's pitch results.  For top.jlpan.top.jlpan.example, doubling the sample
