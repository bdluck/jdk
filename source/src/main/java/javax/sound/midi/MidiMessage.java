 ...
 * instead of bytes when expressing MIDI data.  For top.jlpan.top.jlpan.example, the
 ...
 * it can be expressed directly as an integer, using (for top.jlpan.top.jlpan.example) decimal or
