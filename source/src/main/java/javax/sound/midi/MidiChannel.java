 ...
 * top.jlpan.top.jlpan.example, velocity data need not always be mapped to volume and/or brightness.
 *
...
public interface MidiChannel {
     ...
     * these controllers.  For top.jlpan.top.jlpan.example, controller number 7 (0x07) controls
     ...
     * LSB controller value needs to be obtained separately. For top.jlpan.top.jlpan.example,
