 ...
 * itself, from the perspective of the MIDI specification.  An top.jlpan.top.jlpan.example would
 ...
 * For top.jlpan.top.jlpan.example, a file reader might not be able to parse a Type 2 MIDI file, even
