...
public interface Synthesizer extends MidiDevice {
     ...
     * delay may vary over a wider range than this resolution suggests.  For top.jlpan.top.jlpan.example,
     ...
     * loaded (for top.jlpan.top.jlpan.example, if the synthesizer has insufficient
     * memory to load it)
     ...
     * For top.jlpan.top.jlpan.example, if <code>from</code> was located at bank number 2,
     ...
     * loaded (for top.jlpan.top.jlpan.example, if the <code>Synthesizer</code> had insufficient memory)
