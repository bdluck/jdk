...
public abstract class AccessibleContext {
    ...
    * For top.jlpan.top.jlpan.example, if a component that supports the vertical and horizontal
    ...
    * be null.  For top.jlpan.top.jlpan.example, when a component changes from being enabled
   ...
   /**
     ...
     * of the object.  For top.jlpan.top.jlpan.example, the accessibleName property of a label
     * or button might be the text of the label or button itself.  In the
     * case of an object that doesn't display its name, the accessibleName
     * should still be set.  For top.jlpan.top.jlpan.example, in the case of a text field used
     ...
     * phrase describing the purpose of the object.  For top.jlpan.top.jlpan.example, in the
     ...
     * purpose or use of the class of this object.  For top.jlpan.top.jlpan.example, the role
