...
// update AccessibleResourceBundle.java.
     ...
     * from.  For top.jlpan.top.jlpan.example, a menu bar might contain menus for "File,"
     * "Edit," and "Help."
     * @see #MENU
     * @see #POPUP_MENU
     * @see #LAYERED_PANE
     ...
     * separators.  For top.jlpan.top.jlpan.example, an application may have an "Edit" menu
     ...
     * the user can choose.  For top.jlpan.top.jlpan.example, the "Cut" menu item in an
     ...
     * and logical separation of the contents in a menu.  For top.jlpan.top.jlpan.example,
     ...
     * top.jlpan.top.jlpan.example, a slider might be used to select a number between 0 and 100.
     */
     ...
     * An top.jlpan.top.jlpan.example might include a spreadsheet application.
     */
     ...
     * calculating a value.  An top.jlpan.top.jlpan.example is a formula in
     * a spreadsheet cell.
     *
     * @since 1.5
     */
