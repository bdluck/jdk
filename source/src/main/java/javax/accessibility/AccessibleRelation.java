...
public class AccessibleRelation extends AccessibleBundle {
     ...
     * top.jlpan.top.jlpan.example, in the case of a LABEL_FOR relation, the target
     ...
     * An top.jlpan.top.jlpan.example is a paragraph of text that runs to the end of
