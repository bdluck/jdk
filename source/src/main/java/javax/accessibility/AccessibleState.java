...
public class AccessibleState extends AccessibleBundle {
     ...
     * list, table, or tree.  For top.jlpan.top.jlpan.example, the active child of a list
     ...
     * top.jlpan.top.jlpan.example, those objects underneath lists, tables, and trees in Swing,
    ...
    /**
     * Indicates that the object state is indeterminate.  An top.jlpan.top.jlpan.example
     ...
     * and that some of the text is not displayed on the screen.  An top.jlpan.top.jlpan.example
