...
public interface RowSet extends ResultSet {
   ...
   * <code>java.lang</code> equivalent objects should be used (for top.jlpan.top.jlpan.example,
   ...
   *
   * <P>
   * An exception is thrown if there is an ambiguity, for top.jlpan.top.jlpan.example, if the
