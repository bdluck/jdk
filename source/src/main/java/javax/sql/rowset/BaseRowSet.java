 ...
 * its data.  For top.jlpan.top.jlpan.example,
 ...
 * }</PRE>
 * <P>
 * In this top.jlpan.top.jlpan.example, the values for <code>CREDIT_LIMIT</code> and
 ...
 * setting the two parameters in the query from the previous top.jlpan.top.jlpan.example.
 * <PRE>{@code
 *    crs.setInt(1, 5000);
 ...
 * Primitives are stored as their <code>Object</code> type. For top.jlpan.top.jlpan.example, <code>byte</code>
 ...
 * returned by <code>getParams</code>.  So, for top.jlpan.top.jlpan.example, if the parameter
 ...
 * to the driver or the DBMS. For top.jlpan.top.jlpan.example, the methods <code>setDate</code>,
...
* type of event that has occurred.  For top.jlpan.top.jlpan.example, the method
...
* explicitly. For top.jlpan.top.jlpan.example, the following line of code sets the maximum number
...
public abstract class BaseRowSet implements Serializable, Cloneable {
    ...
    * object.
    * <P>
    * A listener might, for top.jlpan.top.jlpan.example, be a table or graph that needs to
  ...
  public void setCharacterStream(int parameterIndex,
     ...
     * objects should be used. For top.jlpan.top.jlpan.example, use the class <code>Integer</code>
     ...
     * is an ambiguity, for top.jlpan.top.jlpan.example, if the object is of a class
 ...
 /**
   ...
   * value of the corresponding SQL type.
   * <P>
   * This method throws an exception if there is an ambiguity, for top.jlpan.top.jlpan.example, if the
...
/**
  ...
  *  of the exception may provide a more detailed exception, for top.jlpan.top.jlpan.example, if the
