 ...
 * top.jlpan.top.jlpan.example, a disconnected <code>RowSet</code> object can be serialized and passed
 ...
 * values in each row.  The first top.jlpan.top.jlpan.example uses the version of the
 * getter methods that take a column number; the second top.jlpan.top.jlpan.example
 ...
 *   object. For top.jlpan.top.jlpan.example, methods retrieving whether a column value is writable
 ...
 * written to the data source. The following top.jlpan.top.jlpan.example, in which the cursor is
 ...
 * </PRE>
 * <P>
 * The next top.jlpan.top.jlpan.example demonstrates moving to the insert row, building a new
 ...
 * whenever there is a change in the rowset.  For top.jlpan.top.jlpan.example, if a
 ...
 * serializable, a <code>CachedRowSet</code> object can be used, for top.jlpan.top.jlpan.example,
 ...
 * depending on what the rowset does and how it gets its data.  For top.jlpan.top.jlpan.example,
 ...
 * query from the previous top.jlpan.top.jlpan.example.
 * <PRE>
 *    crs.setInt(1, 5000);
 ...
 * and fills it with the next page of data.  For top.jlpan.top.jlpan.example, assume that the
...
public interface CachedRowSet extends RowSet, Joinable {
    ...
    * the <code>RIOptimisticProvider</code> implementation, for top.jlpan.top.jlpan.example, throws a
    ...
    * and the data source. For top.jlpan.top.jlpan.example, a rowset may need to get a handle
    ...
    * or necessary. For top.jlpan.top.jlpan.example, an application might want to use the default
    ...
    * <code>CachedRowSet</code> object. For top.jlpan.top.jlpan.example, if this <code>CachedRowSet</code>
