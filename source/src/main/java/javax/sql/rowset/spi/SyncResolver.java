 ...
 * to navigate a <code>SyncResolver</code> object. For top.jlpan.top.jlpan.example, an application can
 ...
 * next section gives an top.jlpan.top.jlpan.example.
 *
 * <H2>Code Example</H2>
 *
 ...
 * <code>catch</code> block takes effect.  In this top.jlpan.top.jlpan.example, which
