 ...
 * that may be edited by hand. Here is an top.jlpan.top.jlpan.example of the properties file
 ...
 * For top.jlpan.top.jlpan.example, here is a possible addition:
 * <PRE>
 ...
 * For top.jlpan.top.jlpan.example, the following code fragment registers a provider implementation
 * on a JNDI context.  This is something a deployer would normally do. In this
 * top.jlpan.top.jlpan.example, <code>MyProvider</code> is being registered on a CosNaming
