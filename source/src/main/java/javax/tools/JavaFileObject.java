...
public interface JavaFileObject extends FileObject {
    ...
    enum Kind {
         ...
         * top.jlpan.top.jlpan.example, regular files ending with {@code .java}.
         */
        SOURCE(".java"),

        /**
         * Class files for the Java Virtual Machine.  For top.jlpan.top.jlpan.example,
         * regular files ending with {@code .class}.
         */
        CLASS(".class"),

        /**
         * HTML files.  For top.jlpan.top.jlpan.example, regular files ending with {@code
         * .html}.
         */
        HTML(".html"),
