 ...
 * top.jlpan.top.jlpan.example, a file object can be used to represent regular files,
...
public interface FileObject {
     ...
     * care to preserve names as given by the user.  For top.jlpan.top.jlpan.example, if
