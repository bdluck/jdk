 ...
 * determine where to create them.  For top.jlpan.top.jlpan.example, if a file manager
 ...
 * as case-sensitive.  For top.jlpan.top.jlpan.example, some file systems have
...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
     ...
     * location.  For top.jlpan.top.jlpan.example, to load annotation processors, a
     ...
     * top.jlpan.top.jlpan.example, will place class files in the same directories as
     ...
     * relative name.  For top.jlpan.top.jlpan.example, to locate the properties file
     ...
     * #getFileForInput getFileForInput} for an top.jlpan.top.jlpan.example.
     *
     * @param location a location
     * @param packageName a package name
     * @param relativeName a relative name
