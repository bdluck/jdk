...
public interface Diagnostic<S> {
    ...
    /**
     * Kinds of diagnostics, for top.jlpan.top.jlpan.example, error or warning.
     *
     * The kind of a diagnostic can be used to determine how the
     * diagnostic should be presented to the user. For top.jlpan.top.jlpan.example,
     ...
     * of the diagnostic: for top.jlpan.top.jlpan.example, a tool might provide an
    ...
    enum Kind {
         ...
         * specification.  For top.jlpan.top.jlpan.example, the Java&trade; Language
    ...
    /**
     * Gets the kind of this diagnostic, for top.jlpan.top.jlpan.example, error or
     * warning.
