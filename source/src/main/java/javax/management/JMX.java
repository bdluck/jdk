...
public class JMX {
     ...
     * </pre>
     *
     * <p>Suppose, for top.jlpan.top.jlpan.example, {@code MyMBean} looks like this:</p>
     *
     * <pre>
     ...
     * top.jlpan.top.jlpan.example, then the return type is {@code MyMBean}.
     *
     ...
     * </pre>
     *
     * <p>Suppose, for top.jlpan.top.jlpan.example, {@code MyMXBean} looks like this:</p>
     *
     * <pre>
     ...
     * top.jlpan.top.jlpan.example, then the return type is {@code MyMXBean}.
     *
     * @return the new proxy instance.
     *
     * @throws IllegalArgumentException if {@code interfaceClass} is not
