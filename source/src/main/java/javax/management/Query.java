 ...
 *
 * <p>As an top.jlpan.top.jlpan.example, suppose you wanted to find all MBeans where the {@code
 ...
 */
 public class Query extends Object   {
      ...
      * For top.jlpan.top.jlpan.example: <code>a*b?c</code> would match a string starting
