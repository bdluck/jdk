...
/**
   ...
   <p>For top.jlpan.top.jlpan.example, suppose you have an interface like this:
...
public class CompositeDataInvocationHandler implements InvocationHandler {
    ...
    */
     ...
     * called on our proxy and hence forwarded to us.  For top.jlpan.top.jlpan.example, if we
