 ...
 * have.  For top.jlpan.top.jlpan.example, {@link SimpleType#INTEGER} is a {@code
...
public abstract class OpenType<T> implements Serializable {
     ...
     *                    For top.jlpan.top.jlpan.example, a 3-dimensional array of Strings has for class name
