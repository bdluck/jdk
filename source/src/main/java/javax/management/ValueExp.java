...
/*
  ...
  write Query.<Number>attr("A"), for top.jlpan.top.jlpan.example, which would be awful.  And,
  ...
  We could reconsider this if the Query methods were augmented, for top.jlpan.top.jlpan.example
  with:
