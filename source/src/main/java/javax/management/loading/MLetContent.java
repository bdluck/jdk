...
public class MLetContent {
     ...
     * top.jlpan.top.jlpan.example <code>codebase</code>.  The values are the associated attribute
     * values.
     ...
     * top.jlpan.top.jlpan.example <code>codebase</code>.  The values are the associated
     * attribute values.
