 ...
 * top.jlpan.top.jlpan.example with an {@link RMIServer} stub obtained without going
 * through JNDI.</p>
 *
 * @since 1.5
 */
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
     ...
     * syntaxes, for top.jlpan.top.jlpan.example:</p>
     *
     * <pre>
        ...
        public void gotIOException(IOException ioe) throws IOException {
            ...
            if (ioe instanceof ServerException) {
                /* Need to unwrap the exception.
                   ...
                   For top.jlpan.top.jlpan.example, a RMIConnnectorServer will wrap a
