...
public interface JMXConnectorServerMBean {
     ...
     * For top.jlpan.top.jlpan.example, if a client machine with an open connection has
     ...
     * address may not always be complete. For top.jlpan.top.jlpan.example the port number may be
