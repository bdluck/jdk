...
public interface JMXConnector extends Closeable {
     ...
     * top.jlpan.top.jlpan.example, if the server has crashed, the close operation might
     ...
     * special treatment of a duplicate entry.  For top.jlpan.top.jlpan.example, if a
