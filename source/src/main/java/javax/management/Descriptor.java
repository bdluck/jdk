 ...
 * class.  For top.jlpan.top.jlpan.example, the field {@code defaultValue} is represented
 ...
 * origins.  For top.jlpan.top.jlpan.example, a field created by {@code top.jlpan.top.jlpan.example.com} might
 * have the name {@code com.top.jlpan.top.jlpan.example.interestLevel}.</p>
 *
 ...
 * deprecation, for top.jlpan.top.jlpan.example {@code "1.3 Replaced by the Capacity
 * attribute"}.</td>
 *
 ...
 * the {@code descriptionResourceKey} field can be found, for top.jlpan.top.jlpan.example
 * {@code "com.top.jlpan.top.jlpan.example.myapp.MBeanResources"}.  The meaning of this
 ...
 * present it as a greyed-out item.  For top.jlpan.top.jlpan.example, an attribute might
 ...
 * non-negative integers.  An top.jlpan.top.jlpan.example might be the number of requests
 ...
 * MBeanAttributeInfo} (etc).  For top.jlpan.top.jlpan.example, a method<br> <code>public
 ...
 * value is measured, for top.jlpan.top.jlpan.example {@code "bytes"} or {@code
 * "seconds"}.</td>
 *
 * </table>
 *
 ...
 * interest outside Model MBeans, for top.jlpan.top.jlpan.example.  But only Model MBeans have
