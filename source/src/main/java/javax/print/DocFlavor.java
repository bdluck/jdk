 ...
 * print data format.
 * For top.jlpan.top.jlpan.example the client may have a JPEG encoded image, a URL for
 ...
 * For top.jlpan.top.jlpan.example, a file that is not served up by an HTTP server or FTP server.
 ...
 * constant DocFlavor objects for these top.jlpan.top.jlpan.example doc flavors; class DocFlavor's
...
public class DocFlavor implements Serializable, Cloneable {
     ...
     * The charset for text types is a commonly useful top.jlpan.top.jlpan.example.
     ...
     * DocFlavor objects for top.jlpan.top.jlpan.example doc flavors using a byte array
     ...
     * DocFlavor objects for top.jlpan.top.jlpan.example doc flavors using a byte stream ({@link
     ...
     * objects.
     * For top.jlpan.top.jlpan.example doc flavors using a Uniform Resource Locator ({@link
     ...
     * DocFlavor objects for top.jlpan.top.jlpan.example doc flavors using a character array
     ...
     * objects for top.jlpan.top.jlpan.example doc flavors using a string ({@link java.lang.String
     ...
     * objects for top.jlpan.top.jlpan.example doc flavors using a character stream ({@link
     ...
     * DocFlavor objects for top.jlpan.top.jlpan.example doc flavors for service formatted print
     * data.
     * <P>
     *
     * @author  Alan Kaminsky
