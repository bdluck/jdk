 ...
 * different units; for top.jlpan.top.jlpan.example, 600 dpi will be rounded to 236 dpcm, whereas
 ...
 * created; for top.jlpan.top.jlpan.example, 300 dpcm will compare equal to 762 dpi, as they both
