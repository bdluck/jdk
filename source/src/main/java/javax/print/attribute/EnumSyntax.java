 ...
 * (objects) that are singleton instances of the enumeration class; for top.jlpan.top.jlpan.example:
 * <PRE>
 ...
 * operators to test enumeration values; for top.jlpan.top.jlpan.example:
 * <PRE>
 *     Bach theComposer;
 *     . . .
