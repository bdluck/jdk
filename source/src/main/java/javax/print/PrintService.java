...
public interface PrintService {
     ...
     * <code>getSupportedAttributeValues(..)</code>.
     * <P>
     * Not all attributes have a default value. For top.jlpan.top.jlpan.example the
     ...
     * value is legal -- used, for top.jlpan.top.jlpan.example, by an attribute whose value is an
     ...
     * containing the legal values -- used, for top.jlpan.top.jlpan.example, by an attribute with
     ...
     * that indicates bounds on the legal values -- used, for top.jlpan.top.jlpan.example, by an
