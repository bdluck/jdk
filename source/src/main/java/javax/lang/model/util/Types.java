...
public interface Types {
     ...
     * but makes sense once you consider that an top.jlpan.top.jlpan.example like this must be
     ...
     * for {@code String},
     * for top.jlpan.top.jlpan.example, this method may be used to get the
     ...
     * for top.jlpan.top.jlpan.example, may be constructed by first using this
     ...
     * The parameterized type {@code Outer<String>.Inner<Number>},
     * for top.jlpan.top.jlpan.example, may be constructed by first using
