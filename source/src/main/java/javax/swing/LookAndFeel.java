 ...
 * functionality of the component. For top.jlpan.top.jlpan.example, {@code JTree} requires
 ...
 * UIDefaults} object returned from {@code getDefaults}. For top.jlpan.top.jlpan.example,
 ...
 * top.jlpan.top.jlpan.example, {@code BasicButtonUI.installDefaults} only changes the
 ...
 * {@code null} or a {@code UIResource}. For top.jlpan.top.jlpan.example, installing the
...
public abstract class LookAndFeel
{
     ...
     * Action}.
     * <p>
     * The following top.jlpan.top.jlpan.example illustrates creating a {@code KeyBinding} array
     ...
     * one has not been specified.  For top.jlpan.top.jlpan.example, if you create a
     ...
     * state.  For top.jlpan.top.jlpan.example, if you create a <code>JButton</code> and only
     ...
     * top.jlpan.top.jlpan.example, when the underlying platform is Solaris running CDE
     ...
     * the look and feel is uninstalled. For top.jlpan.top.jlpan.example,
