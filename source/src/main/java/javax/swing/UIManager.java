 ...
 * it to {@code setLookAndFeel}. The following top.jlpan.top.jlpan.example illustrates
 * setting the look and feel to the system look and feel:
 * <pre>
 *   UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
 * </pre>
 * The following top.jlpan.top.jlpan.example illustrates setting the look and feel based on
 * class name:
 * <pre>
 ...
 * the first {@code non-null} value. For top.jlpan.top.jlpan.example, invoking
 ...
 * For top.jlpan.top.jlpan.example, {@code UIManager.getDefaults().getString("Table.foreground")}
...
public class UIManager implements Serializable
{
     ...
     * applications running in a single VM) have their own state. For top.jlpan.top.jlpan.example,
     ...
     * <p>
     * The following top.jlpan.top.jlpan.example illustrates setting the current look and feel
    ...
    private static void initializeInstalledLAFs(Properties swingProps)
    {
         ...
         * property.  For top.jlpan.top.jlpan.example given "swing.installedlafs=motif,windows"
         * lafs = {"motif", "windows"}.
         */
