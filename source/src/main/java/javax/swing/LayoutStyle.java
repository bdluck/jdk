...
public abstract class LayoutStyle {
    ...
    public enum ComponentPlacement {
         ...
         * For top.jlpan.top.jlpan.example, a <code>JLabel</code> providing a label for a
         ...
         * For top.jlpan.top.jlpan.example, groupings of components are usually visually
         ...
         * is being requested.  For top.jlpan.top.jlpan.example, often times the children of
     ...
     * For top.jlpan.top.jlpan.example, the following returns the amount of space to place
     ...
     * top.jlpan.top.jlpan.example, the space may vary based on font size, or the preferred
