 ...
 *     can be used, for top.jlpan.top.jlpan.example, to display the flyover text for a button
 ...
 *          the value if it is {@code non-null}. For top.jlpan.top.jlpan.example, if
...
public interface Action extends ActionListener {
     ...
     * commonly used to specify a mnemonic.  For top.jlpan.top.jlpan.example:
     ...
     * that have a meaningful selection state.  For top.jlpan.top.jlpan.example,
     ...
     * by the component and set by the component.  For top.jlpan.top.jlpan.example,
