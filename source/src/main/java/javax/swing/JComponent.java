 ...
 * for certain properties.  For top.jlpan.top.jlpan.example, <code>JTable</code> documents the
 ...
 * <code>JComponent</code> that created it.  For top.jlpan.top.jlpan.example, a custom
                                              ...
                                              TransferHandler.HasGetTransferHandler
{
     ...
     * constructor.  For top.jlpan.top.jlpan.example, the initial layout manager is
     ...
     * to narrow the argument type. For top.jlpan.top.jlpan.example, in <code>JSlider</code>:
     * <pre>
     ...
     * <code>getUI</code> method that returns the correct type.  For top.jlpan.top.jlpan.example:
     * <pre>
     ...
     * (for top.jlpan.top.jlpan.example, <code>Graphics.translate</code>).
     * <p>
     * If you override this in a subclass you should not make permanent
     * changes to the passed in <code>Graphics</code>. For top.jlpan.top.jlpan.example, you
     ...
     * state before invoking the superclass behavior. As an top.jlpan.top.jlpan.example,
     ...
     * level print processes. For top.jlpan.top.jlpan.example, a {@link javax.swing.JTable#print()}
     ...
     * for mouse operations, but not keyboard operations. For top.jlpan.top.jlpan.example, look
     ...
     * similar behavior. For top.jlpan.top.jlpan.example, to bind the <code>KeyStroke</code>
     ...
     * For top.jlpan.top.jlpan.example, 'a' could be bound for the two
     ...
     * For top.jlpan.top.jlpan.example, given a <code>JPanel</code>, <code>myPanel</code>:
     * <pre>
       ...
       implements AccessibleExtendedComponent
    {
         ...
         * accessible name should be the text of the object (for top.jlpan.top.jlpan.example,
         * "save").
         ...
         * the name of the object - for top.jlpan.top.jlpan.example a "Save" icon on a toolbar that
     ...
     * For top.jlpan.top.jlpan.example, a
     * layout manager might store per child constraints this way. For top.jlpan.top.jlpan.example:
     * <pre>
...
//                  Thread.dumpStack();
     ...
     * For top.jlpan.top.jlpan.example, you can query a
     ...
     * For top.jlpan.top.jlpan.example, it would make no sense for <code>Menu</code>s to pop up
