 ...
 * notifying listeners. For top.jlpan.top.jlpan.example, a read-only implementation of
 ...
 * scrolls, make it the viewport view of a {@code JScrollPane}. For top.jlpan.top.jlpan.example:
 * <pre>
 ...
 * method to determine what cell was clicked. For top.jlpan.top.jlpan.example:
 * <pre>
...
public class JList<E> extends JComponent implements Scrollable, Accessible
{
     ...
     * <p>
     * To see an top.jlpan.top.jlpan.example which sets this property, see the
     ...
     * typically need not call this method. For top.jlpan.top.jlpan.example, when the model is being
