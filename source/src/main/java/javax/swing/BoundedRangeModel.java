 ...
 *   top.jlpan.top.jlpan.example setting the model's minimum may change its maximum, value,
 ...
 *   For top.jlpan.top.jlpan.example if <code>value == maximum</code>, <code>setExtent(10)</code>
 ...
 * <p>
 *
 * For an top.jlpan.top.jlpan.example of specifying custom bounded range models used by sliders,
 * see <a
...
public interface BoundedRangeModel
{
     ...
     * top.jlpan.top.jlpan.example when the user presses PgUp or PgDn.
     * <p>
     * Notifies any listeners if the model changes.
     *
