 ...
 * model so that they are not shown in the view.  For top.jlpan.top.jlpan.example, a
 ...
 * For top.jlpan.top.jlpan.example, when a filter is
 ...
 * each of the columns in that entry.  The following top.jlpan.top.jlpan.example shows an
 ...
 * top.jlpan.top.jlpan.example, the following assumes a specific model that is wrapping
 ...
 * </pre>
 *
 * @param <M> the type of the model; for top.jlpan.top.jlpan.example <code>PersonModel</code>
...
public abstract class RowFilter<M,I> {
     ...
     * top.jlpan.top.jlpan.example, the following creates a <code>RowFilter</code> that
     ...
     * string respectively.  For top.jlpan.top.jlpan.example, "^foo$" includes only rows whose
     * string is exactly "foo" and not, for top.jlpan.top.jlpan.example, "food".  See
     ...
     * criteria.  For top.jlpan.top.jlpan.example, the following <code>RowFilter</code> includes
     ...
     * specified criteria.  For top.jlpan.top.jlpan.example, the following
     ...
     * <p>
     * The following top.jlpan.top.jlpan.example creates a <code>RowFilter</code> that will
    ...
    public static abstract class Entry<M, I> {
         ...
         * top.jlpan.top.jlpan.example, when used with a table this corresponds to the
         * number of columns.
         *
