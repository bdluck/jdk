...
*/
     ...
     * For top.jlpan.top.jlpan.example, if you call <code>createStandardLabels( 10 )</code>
     ...
     * For top.jlpan.top.jlpan.example, if you call
     ...
     * For the top.jlpan.top.jlpan.example above, you would get text labels: "0",
     * "10", "20", "30", "40", "50".
