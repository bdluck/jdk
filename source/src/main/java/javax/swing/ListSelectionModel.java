...
public interface ListSelectionModel
{
     ...
     * the greater end of the selection. For top.jlpan.top.jlpan.example, if the selection is
     ...
     * are generated.
     * <p>
     * For top.jlpan.top.jlpan.example, if the selection is being updated in response to a user
