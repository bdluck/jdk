 ...
 * for these cases are provided.  For top.jlpan.top.jlpan.example to create the model in
 * the previous top.jlpan.top.jlpan.example, one could also write:
 * <pre>
...
public class SpinnerNumberModel extends AbstractSpinnerModel implements Serializable
{
     ...
     * For top.jlpan.top.jlpan.example if value was a <code>Long</code>,
     ...
     * <code>setMinimum</code></a> for an top.jlpan.top.jlpan.example.
     * <p>
