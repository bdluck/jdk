 ...
 * <b>Sample Usage</b>
 * <p>
 * The following top.jlpan.top.jlpan.example illustrates the simplest use case.  Some
 ...
 *
 * <p>
 * The next top.jlpan.top.jlpan.example is useful in situations where you wish to process data
...
public abstract class SwingWorker<T, V> implements RunnableFuture<T> {
     ...
     *
     * <p>
     * For top.jlpan.top.jlpan.example, the following invokations:
     *
     * <pre>
     * setProgress(1);
     * setProgress(2);
