 ...
 * source -- for top.jlpan.top.jlpan.example, a text file. That data source is the
 ...
 * corner for it to exist in. For top.jlpan.top.jlpan.example, consider a component set into the
...
public class JScrollPane extends JComponent implements ScrollPaneConstants, Accessible
{
     ...
     * For top.jlpan.top.jlpan.example, if <code>vsbPolicy</code> is
     ...
     * to be displayed in the scrollpane. For top.jlpan.top.jlpan.example:
     * <pre>
     ...
     * to the scrollpane.  For top.jlpan.top.jlpan.example:
     * <pre>
     * JScrollPane scrollpane = new JScrollPane();
     * scrollpane.setViewportView(myBigComponentToScroll);
     ...
     * corners, if there's room.   For top.jlpan.top.jlpan.example with both scrollbars
