 ...
 * two coordinate systems: that of the view (for top.jlpan.top.jlpan.example a
 ...
 *     appropriate user gesture has occurred to trigger a sort.  For top.jlpan.top.jlpan.example,
 ...
 * For top.jlpan.top.jlpan.example, if a database does the sorting,
 ...
 * top.jlpan.top.jlpan.example, if a row is updated in a <code>TableModel</code>
...
public abstract class RowSorter<M> {
     ...
     * changed.  For top.jlpan.top.jlpan.example, if the number of columns in a
     ...
     * be less than the size of the model after the change. For top.jlpan.top.jlpan.example,
     ...
     * For top.jlpan.top.jlpan.example, if you have a 5-row model and delete 3 items from the end
