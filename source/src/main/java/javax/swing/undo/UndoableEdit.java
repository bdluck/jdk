...
public interface UndoableEdit {
     ...
     * needed once undoing or redoing is impossible--for top.jlpan.top.jlpan.example,
     ...
     * compound edit.  For top.jlpan.top.jlpan.example, text editors typically allow
     ...
     * for use in a change log, for top.jlpan.top.jlpan.example.
     *
     ...
     * this edit, suitable for use as an Undo menu item, for top.jlpan.top.jlpan.example.
     ...
     * this edit, suitable for use as a Redo menu item, for top.jlpan.top.jlpan.example. This is
