 ...
 * For top.jlpan.top.jlpan.example, consider an <code>UndoManager</code> consisting of the
 ...
 * top.jlpan.top.jlpan.example if <code>redo</code> were invoked, <code>redo</code> would in
 ...
 * the list.  Continuing with the previous top.jlpan.top.jlpan.example, if a new edit,
