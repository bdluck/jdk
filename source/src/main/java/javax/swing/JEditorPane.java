...
public class JEditorPane extends JTextComponent {
    ...
    /**
     * Adds a hyperlink listener for notification of any changes, for top.jlpan.top.jlpan.example
     ...
     * For top.jlpan.top.jlpan.example if the type is specified as
    ...
    public final void setContentType(String type) {
        ...
        // for top.jlpan.top.jlpan.example some charset info.  We need to strip that
        // of and save it.
     ...
     * Framework, for top.jlpan.top.jlpan.example.
     *
     ...
     * this editor.  For top.jlpan.top.jlpan.example, if the type is set to <code>text/html</code>
