...
public interface Scrollable
{
     ...
     * For top.jlpan.top.jlpan.example, the preferred size of a <code>JList</code> component
     ...
     * For top.jlpan.top.jlpan.example a normal
     ...
     * Scrollable to match the height of the viewport.  For top.jlpan.top.jlpan.example a
