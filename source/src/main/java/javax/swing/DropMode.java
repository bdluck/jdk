...
public enum DropMode {
     ...
     * a list of items (list and tree for top.jlpan.top.jlpan.example), the drop location
     ...
     * (table for top.jlpan.top.jlpan.example), the drop location should indicate
