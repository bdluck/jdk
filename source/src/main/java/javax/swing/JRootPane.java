...
public class JRootPane extends JComponent implements Accessible {
     ...
     * true, but may be set to false in special situations.  For top.jlpan.top.jlpan.example,
...
// PENDING(klobad) Should this reparent the contentPane and MenuBar?
     ...
     * For top.jlpan.top.jlpan.example, calls to <code>revalidate</code>, are pushed upwards to
