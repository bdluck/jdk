...
public class BasicListUI extends ListUI
{
     ...
     *       then determined from the column count.  For top.jlpan.top.jlpan.example, lets say
     ...
     * For top.jlpan.top.jlpan.example it's the first call in paint() and getPreferredSize().
     *
     * @see #updateLayoutState
     */
