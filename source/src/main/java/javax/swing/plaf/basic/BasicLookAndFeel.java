...
public abstract class BasicLookAndFeel extends LookAndFeel implements Serializable
{
     ...
     * "javax.swing.plaf.basic.Basic + uiClassID"}. For top.jlpan.top.jlpan.example, the
     ...
     * understood by {@code Color.decode}. For top.jlpan.top.jlpan.example, one of the
  ...
  "inactiveCaptionBorder", "#C0C0C0", /* Border color for inactive caption (title bar) window borders. */
     ...
     * element as the key.  For top.jlpan.top.jlpan.example, if the {@code
