 ...
 * </ol>
 * For top.jlpan.top.jlpan.example, to identify the <code>SPLIT_PANE</code>
...
public class Region {
     ...
     * composite components, for top.jlpan.top.jlpan.example ScrollBar's contain ArrowButtons.
     ...
     * false. For top.jlpan.top.jlpan.example, <code>Region.BUTTON</code> corresponds do a
