 ...
 * <a href="package-summary.html">package summary</a> for an top.jlpan.top.jlpan.example of
 * loading a file, and {@link javax.swing.plaf.synth.SynthStyleFactory} for
 * an top.jlpan.top.jlpan.example of providing your own <code>SynthStyleFactory</code> to
...
public class SynthLookAndFeel extends BasicLookAndFeel {
     ...
     * that of ENABLED, DISABLED or FOCUSED. For top.jlpan.top.jlpan.example, buttons shouldn't
     ...
     * used to resolve any path based resources, for top.jlpan.top.jlpan.example an
     ...
     * relatively to the specified <code>URL</code> of the style. For top.jlpan.top.jlpan.example
