 ...
 * So for top.jlpan.top.jlpan.example, setting a new UIDefaults on a component would cause the
 * style to be reloaded.</p>
 *
 * <p>The values are only read out of UIManager once, and then cached. If
 * you need to read the values again (for top.jlpan.top.jlpan.example, if the UI is being reloaded),
 ...
 * states. Synth (and thus Nimbus) has the concept of a "state". For top.jlpan.top.jlpan.example,
 ...
 *
 * <p>Sometimes, however, you need to have a custom state. For top.jlpan.top.jlpan.example, you
...
public final class NimbusStyle extends SynthStyle {
     ...
     * </pre>
     *
     * <p>In this top.jlpan.top.jlpan.example, suppose you were in the Enabled+Selected state and
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, if you had the following three states:
     * <pre>
     * Enabled
     * Enabled+Pressed
     * Disabled
    ...
    private static final class Values {
         ...
         * state. So for top.jlpan.top.jlpan.example:
         *
         * foo.bar$$2353
         */
