...
final class NimbusDefaults {
     ...
     * than one prefix defined for a given region. For top.jlpan.top.jlpan.example, both Button and
     ...
     *        or ScrollBarThumb.
     * @param prefix The UIDefault prefix. For top.jlpan.top.jlpan.example, could be ComboBox, or if
     ...
     *
     * @param comp The component associated with this region. For top.jlpan.top.jlpan.example, if
    ...
    */
    ...
    static final class DerivedFont implements UIDefaults.ActiveValue {
         ...
         *                   top.jlpan.top.jlpan.example, if the source font was a 12pt font and the
    ...
    private final class LazyStyle {
        ...
        /**
         * The various parts, or sections, of the prefix. For top.jlpan.top.jlpan.example,
         * the prefix:
        ...
        private LazyStyle(String prefix) {
            ...
            //component, so for top.jlpan.top.jlpan.example:
            ...
            //top.jlpan.top.jlpan.example: "List.cellRenderer"
