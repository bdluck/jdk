...
public abstract class AbstractRegionPainter implements Painter<JComponent> {
    ...
    */
     ...
     * @param c The JComponent related to the drawing event. For top.jlpan.top.jlpan.example, if the
    ...
    protected static class PaintContext {
         ...
         *             For top.jlpan.top.jlpan.example, if maxH is 2, then we will attempt to scale any cached images up to 2x the canvas
         ...
         *             For top.jlpan.top.jlpan.example, if maxV is 2, then we will attempt to scale any cached images up to 2x the canvas
