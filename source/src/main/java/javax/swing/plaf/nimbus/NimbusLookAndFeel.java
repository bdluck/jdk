...
public class NimbusLookAndFeel extends SynthLookAndFeel {
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, suppose I had a component named JFoo. Suppose I then registered
     ...
     * For top.jlpan.top.jlpan.example, suppose you wanted to style the background of a JPanel
     ...
     * top.jlpan.top.jlpan.example "Button.background" --> "Button[Enabled].backgound"
     */
