...
class ImageScalingHelper {
     ...
     * For top.jlpan.top.jlpan.example PAINT_ALL | PAINT_CENTER will paint all but the center.
     */
     ...
     *                  specified will not be painted, for top.jlpan.top.jlpan.example PAINT_ALL | PAINT_CENTER paints everything but the
     *                  center.
     */
