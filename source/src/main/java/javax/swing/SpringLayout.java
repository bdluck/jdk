...
public class SpringLayout implements LayoutManager2 {
     ...
     * </pre>
     * <p>
     * For top.jlpan.top.jlpan.example, if you have specified the WIDTH and WEST (X) location
     ...
     * For top.jlpan.top.jlpan.example, "a + b" is equal to
     ...
     * For top.jlpan.top.jlpan.example, if the <code>WEST</code>, <code>WIDTH</code> and
