...
public class DefaultTreeSelectionModel implements Cloneable, Serializable, TreeSelectionModel
{
     ...
     * for the new mode. For top.jlpan.top.jlpan.example, if three TreePaths are
     ...
     * in the returned array. For top.jlpan.top.jlpan.example, if the selection consists
     ...
     * (for top.jlpan.top.jlpan.example, a node has been expanded).
