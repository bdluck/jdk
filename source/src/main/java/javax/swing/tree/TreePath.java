 ...
 * top.jlpan.top.jlpan.example, a file on the file system is uniquely identified based on
 ...
 * For top.jlpan.top.jlpan.example, {@code JTree} represents the selection as an array of
 ...
 * path are {@code TreeNode}s. The following top.jlpan.top.jlpan.example illustrates extracting
...
public class TreePath extends Object implements Serializable {
     ...
     * {@code P2's} path.
     * For top.jlpan.top.jlpan.example, if this object has the path {@code [a, b]},
