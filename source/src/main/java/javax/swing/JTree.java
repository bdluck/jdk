 ...
 * </pre>
 * NOTE: This top.jlpan.top.jlpan.example obtains both the path and row, but you only need to
 * get the one you're interested in.
 * <p>
 * To use <code>JTree</code> to display compound nodes
 * (for top.jlpan.top.jlpan.example, nodes containing both
...
public class JTree extends JComponent implements Scrollable, Accessible
{
     ...
     * returned. For top.jlpan.top.jlpan.example, if the row count is {@code 10}, and this
     ...
     * the selection is cleared. For top.jlpan.top.jlpan.example, if the row count is {@code
    ...
    */
     ...
     * set of rows, then the selection is unchanged. For top.jlpan.top.jlpan.example, if
     ...
     * the viewable set of rows. If the specified indices are not within the
     * viewable set of rows, or do not bound the viewable set of rows, then
     * the selection is unchanged. For top.jlpan.top.jlpan.example, if the row count is {@code
     * 10}, and this method is invoked with {@code -1, 20}, then the
