 ...
 * the constructor.  For top.jlpan.top.jlpan.example, to transfer the foreground color from
...
public class TransferHandler implements Serializable {
    ...
    public final static class TransferSupport {
         ...
         * against the original action. For top.jlpan.top.jlpan.example:
         * <pre>
     ...
     *  handler (a subclass that performs some other kind of transfer, for top.jlpan.top.jlpan.example)
     */
