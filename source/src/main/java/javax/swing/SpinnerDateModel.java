 ...
 * For top.jlpan.top.jlpan.example, if <code>calendarField</code> is <code>Calendar.DAY_OF_WEEK</code>,
...
public class SpinnerDateModel extends AbstractSpinnerModel implements Serializable
{
     ...
     * For top.jlpan.top.jlpan.example <code>start</code> might be an instance of a class like this:
     * <pre>
     ...
     * }
     * </pre>
     * Note that the above top.jlpan.top.jlpan.example will throw a <code>ClassCastException</code>
     ...
     * <code>Date</code>s.  See <code>setStart</code> for an top.jlpan.top.jlpan.example.
     * <p>
