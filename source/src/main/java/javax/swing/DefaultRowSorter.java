 ...
 * documented in the subclasses (for top.jlpan.top.jlpan.example, {@link
 ...
 * implementation (for top.jlpan.top.jlpan.example, {@link
 ...
 * first type parameter corresponds to the class of the model, for top.jlpan.top.jlpan.example
...
public abstract class DefaultRowSorter<M, I> extends RowSorter<M> {
     ...
     * top.jlpan.top.jlpan.example, assume a table row sorter is created and
     ...
     * top.jlpan.top.jlpan.example, if this is true and the user edits an entry the
