 ...
 * <code>DefaultCellEditor</code> for top.jlpan.top.jlpan.example).  The wrapper approach
...
public interface CellEditor {
     ...
     * selection.  (See Netscape Communicator for just such an top.jlpan.top.jlpan.example)
