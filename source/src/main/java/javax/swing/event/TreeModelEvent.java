...
public class TreeModelEvent extends EventObject {
     ...
     * for top.jlpan.top.jlpan.example, or it might encapsulate multiple inserts and deletes in the
     ...
     *               different mechanism -- for top.jlpan.top.jlpan.example, a node ID number
     *
