 ...
 * an endOffset == (getLength() + 1). For top.jlpan.top.jlpan.example, in DefaultStyledDocument
...
public abstract class AbstractDocument implements Document, Serializable {
     ...
     * parts of the document are being scanned.  The following is an top.jlpan.top.jlpan.example
