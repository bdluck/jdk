 ...
 * HTML views.  An user with poor vision for top.jlpan.top.jlpan.example would want
...
*/
     ...
     * For top.jlpan.top.jlpan.example, lets say you wanted to create an action to insert
