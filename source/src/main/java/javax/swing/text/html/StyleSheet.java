 ...
 * defined by an element are not well defined. For top.jlpan.top.jlpan.example, the html
 ...
 * Therefore, in the previous top.jlpan.top.jlpan.example the background would have a
...
public class StyleSheet extends StyleContext {
    ...
    //   and stored in an inverted graph, for top.jlpan.top.jlpan.example:
    ...
    //   top.jlpan.top.jlpan.example, if the developer adds StyleConsants.BOLD, FALSE to an
     ...
     * String of the element names. For top.jlpan.top.jlpan.example, <code>selector</code>
