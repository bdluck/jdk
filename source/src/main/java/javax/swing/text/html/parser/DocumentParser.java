 ...
 * tags that are implied but not explicitly specified. For top.jlpan.top.jlpan.example, the
 ...
 * For top.jlpan.top.jlpan.example &lt;p foo=bar class=neat&gt; has two attributes. foo is
 ...
 * the location of the next encountered tag. In the first top.jlpan.top.jlpan.example,
