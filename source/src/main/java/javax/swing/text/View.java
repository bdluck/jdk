...
public abstract class View implements SwingConstants {
     ...
     * children.  For top.jlpan.top.jlpan.example, a view of a paragraph will
     ...
     * than a view that has no whitespace, for top.jlpan.top.jlpan.example.  The
     ...
     * attractive to try and break the view.  An top.jlpan.top.jlpan.example of
     * a view that does support breaking is <code>LabelView</code>.
     * An top.jlpan.top.jlpan.example of a view that uses break weight is
