 ...
 * you to specify which characters are valid. For top.jlpan.top.jlpan.example, the following
 ...
 * be used. Precedence is given to the placeholder string. For top.jlpan.top.jlpan.example:
 * <pre>
 ...
 * previous top.jlpan.top.jlpan.example. Both inserts will result in the same String,
...
public class MaskFormatter extends DefaultFormatter {
     ...
     * characters in mask.
     * <p>
     * For top.jlpan.top.jlpan.example, if the mask is <code>'(###) ###-####'</code>, the
     ...
     *     the literals.  For top.jlpan.top.jlpan.example, in pasing in 5551212 into ###-####
     ...
     *     eat literals in the text. For top.jlpan.top.jlpan.example, if you paste '555' into
