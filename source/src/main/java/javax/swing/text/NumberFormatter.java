 ...
 * invalid numbers, for top.jlpan.top.jlpan.example, <code>setAllowsInvalid(false)</code>):
 * <ul>
 ...
 * overwrite mode, <code>setOverwriteMode(true)</code>. For top.jlpan.top.jlpan.example:
 * <pre>
 ...
 * type the value class represents. For top.jlpan.top.jlpan.example:
