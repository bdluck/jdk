...
public class JFileChooser extends JComponent implements Accessible {
     ...
     * (for top.jlpan.top.jlpan.example, to preview files).
     */
     ...
     * For top.jlpan.top.jlpan.example, the following code
     ...
     * relative to the frame (for top.jlpan.top.jlpan.example, centered over the frame).
     ...
     * (for top.jlpan.top.jlpan.example, centered over the component).
     ...
     * For top.jlpan.top.jlpan.example, on Microsoft Windows this would be All Files (*.*).
     */
