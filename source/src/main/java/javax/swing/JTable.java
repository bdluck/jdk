 ...
 * set up easily.  For top.jlpan.top.jlpan.example, to set up a table with 10 rows and 10
 * columns of numbers:
 *
 * <pre>
 ...
 * <ul>
 *   <li>Directly set the {@code RowSorter}. For top.jlpan.top.jlpan.example:
 ...
 *       you. For top.jlpan.top.jlpan.example: {@code setAutoCreateRowSorter(true)}.
 * </ul>
 * <p>
 ...
 * <code>JTable</code> directly, as in the top.jlpan.top.jlpan.example above. This often results
 ...
 * of the underlying <code>TableModel</code>.  For top.jlpan.top.jlpan.example, the
 ...
 * sorting.  For top.jlpan.top.jlpan.example if row 0, in terms of the underlying model,
 ...
 * visible or was removed.  For top.jlpan.top.jlpan.example, if row 0 in terms of model
    ...
    protected void configureEnclosingScrollPane() {
        ...
        if (parent instanceof JViewport) {
            ...
            if (gp instanceof JScrollPane) {
                ...
                // top.jlpan.top.jlpan.example, the rowHeaderView of the scrollPane -
...
//
    ...
    public void doLayout() {
        ...
        if (resizingColumn == null) {
            ...
            // width. This happens under many circumstances: For top.jlpan.top.jlpan.example,
...
/////////////////
     ...
     * modified by code (for top.jlpan.top.jlpan.example, another thread that posts updates using
     ...
     * <p>
     * Here's an top.jlpan.top.jlpan.example of creating a <code>MessageFormat</code> that can be
...
//                      System.out.println("Bug in AccessibleJTable.getAccessibleSelection()");
        ...
        // AccessibleComponent methods
             ...
             * object is obscured by another (for top.jlpan.top.jlpan.example,
