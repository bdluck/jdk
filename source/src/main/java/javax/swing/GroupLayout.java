 ...
 * <p style="text-align:center">
 * <img src="doc-files/groupLayout.top.jlpan.top.jlpan.example.png" alt="Produced horizontal/vertical form">
 * <p>
 ...
 *       top.jlpan.top.jlpan.example, {@code group.addComponent(label1).addComponent(label2);} is
 *       equivalent to
...
public class GroupLayout implements LayoutManager2 {
     ...
     * created.  For top.jlpan.top.jlpan.example, if this is {@code true} and you add two
     ...
     * positioned that do not fill the group. For top.jlpan.top.jlpan.example, if a {@code
     ...
     * the linked components. For top.jlpan.top.jlpan.example, if you link two components with
     ...
     * top.jlpan.top.jlpan.example, if you link two components along the horizontal axis
     ...
     * from the component should be used.  For top.jlpan.top.jlpan.example, if {@code
     ...
     * The following top.jlpan.top.jlpan.example adds {@code myComponent} to {@code group}
     ...
     * </pre>
     * The following top.jlpan.top.jlpan.example adds {@code myComponent} to {@code group} using
    ...
    public abstract class Group extends Spring {
         ...
         * will be combined.  For top.jlpan.top.jlpan.example, a group that layed things out
