 ...
 * single JRootPane, specially.  For top.jlpan.top.jlpan.example in a GUI builder,
 ...
 * For top.jlpan.top.jlpan.example, you can add a child component to a frame as follows:
 * <pre>
 *       frame.add(child);
 * </pre>
 * instead of:
...
public interface RootPaneContainer
{
     ...
     * to the RootPaneContainer that isn't layout managed.  For top.jlpan.top.jlpan.example
