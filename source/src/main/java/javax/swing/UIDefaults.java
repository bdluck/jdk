...
public class UIDefaults extends Hashtable<Object,Object>
{
     ...
     * key/value pairs.  For top.jlpan.top.jlpan.example:
     * <pre>
        Object[] uiDefaults = {
     ...
     * the real value.  Here's an top.jlpan.top.jlpan.example of a <code>LazyValue</code>
     ...
     * the <code>getXXX(key)</code> methods. Here's an top.jlpan.top.jlpan.example of
     ...
     * can have a mnemonic. For top.jlpan.top.jlpan.example:
