 ...
 * of repaints to be minimized, for top.jlpan.top.jlpan.example by collapsing multiple
...
public class RepaintManager
{
    ...
    // top.jlpan.top.jlpan.example, if we paint a component and show it and the buffer has
