 ...
 * expected in the <code>paint</code> method. For top.jlpan.top.jlpan.example, you may wish to write a
...
public interface Painter<T> {
     ...
     * For top.jlpan.top.jlpan.example, it could be of type <code>Component</code>. A <code>Painter</code>
     * that expected it could then read state from that <code>Component</code> and
     * use the state for painting. For top.jlpan.top.jlpan.example, an implementation may read the
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, suppose I have a <code>Painter</code> implementation that draws
