...
public abstract class AbstractButton extends JComponent implements ItemSelectable, SwingConstants {
     ...
     * an icon only button, for top.jlpan.top.jlpan.example, then you should set
     ...
     * you do not wish the default character to be underlined. For top.jlpan.top.jlpan.example, if
     ...
     * where this behavior is not desirable (for top.jlpan.top.jlpan.example, the "OK" button
     ...
     * top.jlpan.top.jlpan.example, <code>JButton</code> might do the following:
     * <pre>
...
///////////////////
    ...
    protected abstract class AccessibleAbstractButton
        ...
        class ButtonKeyBinding implements AccessibleKeyBinding {
             ...
             * on the underlying implementation of the key.  For top.jlpan.top.jlpan.example, if the
