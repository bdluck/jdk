 ...
 * <p>
 * Another top.jlpan.top.jlpan.example would be a multi-column component,
 ...
 * However, any other unit of measure (for top.jlpan.top.jlpan.example, time in days)
...
public class SizeSequence {
     ...
     * For top.jlpan.top.jlpan.example, <code>getPosition(0)</code> returns 0,
     ...
     * For top.jlpan.top.jlpan.example, <code>getIndex(0)</code> is 0,
