 ...
 * The following top.jlpan.top.jlpan.example shows adding sorting to a <code>JTable</code>:
 * <pre>
 ...
 * top.jlpan.top.jlpan.example, to get the selection in terms of <code>myModel</code>
 ...
 * </pre>
 * <p>
 * The previous top.jlpan.top.jlpan.example assumes you have not enabled filtering.  If you
 ...
 * method. The following top.jlpan.top.jlpan.example will only show rows containing the string
 * "foo":
 * <pre>
 *   TableModel myModel = createMyTableModel();
 ...
 * Refer to the documentation of <code>RowFilter</code> for an top.jlpan.top.jlpan.example
 * of this.
 * <p>
