...
public interface ImageInputStream extends DataInput, Closeable {
     ...
     * from this stream.  For top.jlpan.top.jlpan.example, the sequence of bytes '0x01
     ...
     * by a smaller number of bytes than requested, for top.jlpan.top.jlpan.example if the
