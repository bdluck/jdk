...
public interface IIOMetadataFormat {
     ...
     * For top.jlpan.top.jlpan.example, a metadata document format might contain an
     ...
     * top.jlpan.top.jlpan.example, an element representing color primary information
     ...
     * with child policy <code>CHILD_POLICY_REPEAT</code>.  For
     * top.jlpan.top.jlpan.example, an element representing an entry in an 8-bit color
