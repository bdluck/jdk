...
public abstract class ImageReader {
     ...
     * top.jlpan.top.jlpan.example, for a JPEG image the raw type might have a YCbCr color
     ...
     * possible.  For top.jlpan.top.jlpan.example, for a JPEG image the first entry should
     ...
     * decoding.
     *
     * <p> For top.jlpan.top.jlpan.example, in progressive JPEG decoding each pass
