...
public abstract class ImageWriterSpi extends ImageReaderWriterSpi {
     ...
     * the encoding format.  For top.jlpan.top.jlpan.example, a service provider for a
     ...
     * providers, may choose to be more or less strict.  For top.jlpan.top.jlpan.example,
