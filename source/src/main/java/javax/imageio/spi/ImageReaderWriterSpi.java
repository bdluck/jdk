...
public abstract class ImageReaderWriterSpi extends IIOServiceProvider {
     ...
     * top.jlpan.top.jlpan.example, a single <code>ImageReader</code> might be able to
     ...
     * service provider.  For top.jlpan.top.jlpan.example, a single
     ...
     * point of view, for top.jlpan.top.jlpan.example <code>image/x-xbitmap</code> and
