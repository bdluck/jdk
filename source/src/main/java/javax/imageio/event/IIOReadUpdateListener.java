...
public interface IIOReadUpdateListener extends EventListener {
     ...
     * for top.jlpan.top.jlpan.example, in order to provide a progressive display effect,
     ...
     * top.jlpan.top.jlpan.example.  A call to this method does not guarantee that all the
     ...
     * updated bands (<code>bands</code>).  For top.jlpan.top.jlpan.example, the update:
     *
     * <pre>
     * minX = 10
     * minY = 20
