...
/**
  ...
  * These are referred to as <em>request controls</em>. For top.jlpan.top.jlpan.example, a
  ...
  * <em>response controls</em>. For top.jlpan.top.jlpan.example, an LDAP server might
