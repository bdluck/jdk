...
/**
  ...
  *<p>
  * For top.jlpan.top.jlpan.example, suppose the LDAP server supported a 'get time' extended operation.
...
public interface ExtendedRequest extends java.io.Serializable {
    ...
    /**
      ...
      *<p>
      * For top.jlpan.top.jlpan.example, a Start TLS extended request class would need to know
