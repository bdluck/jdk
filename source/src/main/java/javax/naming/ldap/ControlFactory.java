...
public abstract class ControlFactory {
    ...
    /**
      ...
      * manner.
      * <p>
      * For top.jlpan.top.jlpan.example, a factory might use the BER encoded data in
      ...
      * should be tried. This might happen, for top.jlpan.top.jlpan.example, if the BER data
      ...
      * but is unable to because of, for top.jlpan.top.jlpan.example invalid BER data.
      */
