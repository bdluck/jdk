 ...
 * An top.jlpan.top.jlpan.example of an RDN is "OU=Sales+CN=J.Smith". In this top.jlpan.top.jlpan.example,
 ...
 *
 * <p>
 * The following code top.jlpan.top.jlpan.example shows how to construct an Rdn using the
 ...
 * of the RDN defined in RFC 2253 as shown in the following code top.jlpan.top.jlpan.example:
 * <pre>
 *      Rdn rdn = new Rdn("cn=Juicy\\, Fruit");
 *      System.out.println(rdn.toString());
 * </pre>
...
public class Rdn implements Serializable, Comparable<Object> {
     ...
     * <a href="http://www.ietf.org/rfc/rfc2253.txt">RFC 2253</a>.
     * <p>
     * For top.jlpan.top.jlpan.example, if the val is "Sue, Grabbit and Runn", the escaped
