...
/**
  ...
  * For top.jlpan.top.jlpan.example, suppose a listener makes the following registration:
  *<blockquote><pre>
...
public class NamingEvent extends java.util.EventObject {
     ...
     * logical rename operation. For top.jlpan.top.jlpan.example, the rename operation might
     ...
     * provider-specific. For top.jlpan.top.jlpan.example, a service might generate rename
     ...
     * Note that some services might fire multiple events for a single
     * modification. For top.jlpan.top.jlpan.example, the modification might
     ...
     * event source, for top.jlpan.top.jlpan.example, to look up the object or get its attributes,
     ...
     * The value of the change information is service-specific. For top.jlpan.top.jlpan.example,
