 ...
 * For top.jlpan.top.jlpan.example, the <tt>ObjectChangeListener</tt>
...
public interface EventContext extends Context {
     ...
     * for top.jlpan.top.jlpan.example, if the caller does not know in advance whether <tt>target</tt>
