...
/**
  ...
  * For top.jlpan.top.jlpan.example, when looking up a printer bound in the name space,
  * if the print service binds printer names to References, the printer
  * Reference could be used to create a printer object, so that
  * the caller of lookup can directly operate on the printer object
  * after the lookup.
  * <p>An <tt>ObjectFactory</tt> is responsible
  * for creating objects of a specific type.  In the above top.jlpan.top.jlpan.example,
 ...
 * An top.jlpan.top.jlpan.example of such an environment property is user identity
 * information.
 *<p>
 ...
 * scheme id.  For top.jlpan.top.jlpan.example, invoking <tt>getObjectInstance()</tt> with
 ...
 * identified by the URL.  For top.jlpan.top.jlpan.example, suppose this is an LDAP URL context
