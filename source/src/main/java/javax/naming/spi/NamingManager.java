...
// --------- object factory stuff
     ...
     *<p>
     * For top.jlpan.top.jlpan.example, if the scheme id is "ldap", and the
     ...
     * <p>
     * For top.jlpan.top.jlpan.example, invoking getObjectInstance() as shown above
     ...
     * context (i.e. not a URL). For top.jlpan.top.jlpan.example, if urlInfo is
