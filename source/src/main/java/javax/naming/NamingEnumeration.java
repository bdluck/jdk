...
/**
  ...
  * <p>
  * For top.jlpan.top.jlpan.example, if the list() is
  ...
  *<p>
  * In another top.jlpan.top.jlpan.example, if a search() method was invoked with a specified
  ...
  * in the previous top.jlpan.top.jlpan.example, after the n'th result has been returned by
...
public interface NamingEnumeration<T> extends Enumeration<T> {
    /**
      ...
      * for top.jlpan.top.jlpan.example, due to a referral or server unavailability, etc.
      *
