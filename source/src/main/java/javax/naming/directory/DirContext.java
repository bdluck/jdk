 ...
 * In some directories, for top.jlpan.top.jlpan.example, the "name" attribute might be the
 ...
 * the same attribute. For top.jlpan.top.jlpan.example, "cn" and "commonName" might both
 * refer to the same attribute. Asking for "cn" might return the
 * "commonName" attribute.
 * <p>
 * Some directories support the language codes for attributes.
 * Asking such a directory for the "description" attribute, for top.jlpan.top.jlpan.example,
 ...
 * purposes. An top.jlpan.top.jlpan.example of operational attributes is the access control
 * list for an object.
 * <p>
 * In the <tt>getAttributes()</tt> and <tt>search()</tt> methods,
 ...
 * (for top.jlpan.top.jlpan.example, when searching a single level context). The documentation
 * of such methods
...
// -------------------- schema operations
     ...
     * For top.jlpan.top.jlpan.example, if the named object is a directory object of
...
// -------------------- search operations
     ...
     * <code>Object.equals</code> method, for top.jlpan.top.jlpan.example, or might use a schema
     ...
     * <p>
     * For the assertion "someCount=127", for top.jlpan.top.jlpan.example, <code>attr</code>
     ...
     * underlying directory. For top.jlpan.top.jlpan.example, for the equals operator, suppose
     ...
     * attributes, for top.jlpan.top.jlpan.example, should accept byte arrays as filter
