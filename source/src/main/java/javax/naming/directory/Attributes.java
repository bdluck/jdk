...
/**
  ...
  * For top.jlpan.top.jlpan.example, you can request from the directory the attributes
  ...
  * created. (see BasicAttributes constructor for top.jlpan.top.jlpan.example).
