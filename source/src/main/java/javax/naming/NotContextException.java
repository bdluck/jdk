...
/**
  ...
  * resolved object is not a context. For top.jlpan.top.jlpan.example, Context.destroy() requires
  * that the named object be a context. If it is not, NotContextException
  * is thrown. Another top.jlpan.top.jlpan.example is a non-context being encountered during
