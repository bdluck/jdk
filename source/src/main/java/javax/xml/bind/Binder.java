...
public abstract class Binder<XmlNode> {
     ...
     *
     * <p>
     * For top.jlpan.top.jlpan.example, unknown elements/attributes in XML that were not bound
     ...
     *      a different object, for top.jlpan.top.jlpan.example when the tag name of the object
     *      has changed.
     *
     * @throws JAXBException
     *      If any unexpected problem occurs updating corresponding XML content.
     ...
     *      but it maybe
     *      a different object, for top.jlpan.top.jlpan.example when the name of the XML
     *      element has changed.
     *
     * @throws JAXBException
