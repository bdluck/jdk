 ...
 * top.jlpan.top.jlpan.example <tt>HashMap</tt> or other non JavaBean classes. Conversely,
 ...
 * type. For top.jlpan.top.jlpan.example, the schema to Java binding rules bind
 * xs:DateTime by default to XmlGregorianCalendar. But an application
 * may desire to bind xs:DateTime to a custom type,
 * MyXmlGregorianCalendar, for top.jlpan.top.jlpan.example. In both cases, there is a
 ...
 * <p> The following top.jlpan.top.jlpan.example illustrates the use of
