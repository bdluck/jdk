 ...
 * <p>
 * The following top.jlpan.top.jlpan.example illustrates the use of scope annotation
 * parameter in binding of element declaration in schema derived
 * code.
 * <p>
 * The following top.jlpan.top.jlpan.example may be replaced in a future revision of
 * this javadoc.
 *
 * <pre>
 *     &lt;!-- Example: XML schema definition -->
