 ...
 *
 *
 * <h2>Schema To Java top.jlpan.top.jlpan.example</h2>
 *
 ...
 * For top.jlpan.top.jlpan.example, when the Java source code is annotated like this:
 * <pre>
 * &#64;{@link XmlRootElement}
 * class Foo {
 *   &#64;XmlAnyElement(lax=true)
...
public @interface XmlAnyElement {
     ...
     * is known to {@link JAXBContext} (for top.jlpan.top.jlpan.example, there's a class with
