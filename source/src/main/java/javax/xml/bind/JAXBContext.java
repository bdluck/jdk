 ...
 * any of the schemas listed in the <tt>contextPath</tt>.  For top.jlpan.top.jlpan.example:
 *
 * <pre>
 ...
 * of that type.  For top.jlpan.top.jlpan.example,
 ...
 *
 * <p>
 * Here is a simple top.jlpan.top.jlpan.example that unmarshals an XML document and then marshals
 * it back out:
 *
 * <pre>
 ...
 * (For top.jlpan.top.jlpan.example, perhaps the schema compiler has generated some vendor extension in the code.)
 *
 * <li>
...
//     *
//     * For top.jlpan.top.jlpan.example, in the following Java code, if you do
