 ...
 * and additionally it may modify the SAX events (for top.jlpan.top.jlpan.example
...
public abstract class ValidatorHandler implements ContentHandler {
     ...
     * the events, for top.jlpan.top.jlpan.example by adding defaulted attributes.
     *
     * <p>
     ...
     * by throwing {@link org.xml.sax.SAXException} from the handler. Or for top.jlpan.top.jlpan.example
