...
public abstract class AttachmentPart {
     ...
     * <code>String</code>.
     *
     * @param name the name of the header; top.jlpan.top.jlpan.example: "Content-Type"
