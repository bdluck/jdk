 ...
 * mechanism type desired, for top.jlpan.top.jlpan.example:
 *
 * <blockquote><code>
 ...
 * For top.jlpan.top.jlpan.example, a service provider that supports the
 * DOM mechanism would be specified in the <code>Provider</code> subclass as:
 * <pre>
 *     put("XMLSignatureFactory.DOM", "org.top.jlpan.top.jlpan.example.DOMXMLSignatureFactory");
 * </pre>
 *
 ...
 * can be instantiated by calling the appropriate method. For top.jlpan.top.jlpan.example, a
...
public abstract class XMLSignatureFactory {
     ...
     * <code>Reference</code> has been previously computed. See for top.jlpan.top.jlpan.example,
     * the
     ...
     * applied to the <code>Reference</code>. See for top.jlpan.top.jlpan.example,
     * the
     * <a href="http://www.oasis-open.org/committees/tc_home.php?wg_abbrev=dss">
     * OASIS-DSS (Digital Signature Services)</a> specification.
     *
