 ...
 * XML mechanism type desired, for top.jlpan.top.jlpan.example:
 *
 * <blockquote><code>
 ...
 * "DOM" is assumed. For top.jlpan.top.jlpan.example, a service provider that supports the
 * XPath Filter 2 Transform and DOM mechanism would be specified in the
 * <code>Provider</code> subclass as:
 * <pre>
 *     put("TransformService." + Transform.XPATH2,
 *         "org.top.jlpan.top.jlpan.example.XPath2TransformService");
 ...
 * exists in XML form (for top.jlpan.top.jlpan.example, when validating an existing
