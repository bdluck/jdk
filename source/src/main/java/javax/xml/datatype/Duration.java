 ...
 * </ol>
 *
 * <p>For top.jlpan.top.jlpan.example, 30 days cannot be meaningfully compared to one month.
 ...
 * fail for some combinations of operations. For top.jlpan.top.jlpan.example, you cannot
 ...
 * decimal numbers. For top.jlpan.top.jlpan.example, one cannot represent 1 sec divided by 3.</p>
 *
...
public abstract class Duration {
     ...
     *   will be discarded (for top.jlpan.top.jlpan.example, if the actual value is 2.5,
     ...
     * For top.jlpan.top.jlpan.example, for any Calendar value <code>x</code>,</p>
     * <pre>
     ...
     * <p>If the seconds field carries more digits than milli-second order,
     * those will be simply discarded (or in other words, rounded to zero.)
     * For top.jlpan.top.jlpan.example, for any <code>Date</code> value <code>x</code>,</p>
     * <pre>
     * <code>new Duration("PT10.00099S").getTimeInMills(x) == 10000</code>.
     * <code>new Duration("-PT10.00099S").getTimeInMills(x) == -10000</code>.
     * </pre>
     ...
     *
     * <p>For top.jlpan.top.jlpan.example,</p>
     * <pre>
     * "1 day" + "-3 days" = "-2 days"
     ...
     *      top.jlpan.top.jlpan.example, adding negative one day to one month causes
     *      this exception.
     *
     *
     ...
     * won't work correctly (for top.jlpan.top.jlpan.example if values of fields
     ...
     * beyond milliseconds will be simply ignored. For top.jlpan.top.jlpan.example, if
     ...
     *      top.jlpan.top.jlpan.example, subtracting one day from one month causes
     *      this exception.
     *
     * @throws NullPointerException
     *      If the rhs parameter is null.
     ...
     * carried down toward the next lower unit. For top.jlpan.top.jlpan.example,
     * if you multiply "P1D" (1 day) with "0.5", then it will be 0.5 day,
     * which will be carried down to "PT12H" (12 hours).
     * When fractions of month cannot be meaningfully carried down
     * to days, or year to months, this will cause an
     * {@link IllegalStateException} to be thrown.
     * For top.jlpan.top.jlpan.example if you multiple one month by 0.5.</p>
     *
     * <p>
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, duration of one month normalizes to 31 days
     ...
     * specification.</p>
     *
     * <p>For top.jlpan.top.jlpan.example, "P1D" (one day) > "PT12H" (12 hours) and
     ...
     *
     * <p>For top.jlpan.top.jlpan.example, "P1D" (1 day) is equal to "PT24H" (24 hours).</p>
     *
     ...
     * For top.jlpan.top.jlpan.example,</p>
     * <pre>
