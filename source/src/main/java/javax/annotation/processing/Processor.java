 ...
 * controlled.  For top.jlpan.top.jlpan.example, for a {@link javax.tools.JavaCompiler
 ...
 * processor being used to, for top.jlpan.top.jlpan.example, implement additional validity
...
public interface Processor {
    ...
    * top.jlpan.top.jlpan.example an {@code int} member whose value should lie between 1
    ...
    * top.jlpan.top.jlpan.example, consider the simple annotation:
    *
    * <blockquote>
    * <pre>
    * &#064;MersennePrime {
    ...
    * top.jlpan.top.jlpan.example, if the user has typed
    *
    * <blockquote>
    * <code>
    * &#064;MersennePrime(1
    ...
    * </blockquote>
    *
    * Sometimes no valid completion is possible.  For top.jlpan.top.jlpan.example, there
