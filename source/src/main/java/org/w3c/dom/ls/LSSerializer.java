 ...
 * as a <code>DOMError</code> fatal error. An top.jlpan.top.jlpan.example would be serializing
...
public interface LSSerializer {
     ...
     * top.jlpan.top.jlpan.example, CDATA sections won't be passed to the filter if "<a href='http://www.w3.org/TR/DOM-Level-3-Core/core.html#parameter-cdata-sections'>
