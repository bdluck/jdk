 ...
 * prefix/URI mapping is repeated for each context (for top.jlpan.top.jlpan.example), this
...
public class NamespaceSupport
{
     ...
     * before they are referenced.  For top.jlpan.top.jlpan.example, a SAX driver (parser)
