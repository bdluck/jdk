 ...
 * top.jlpan.top.jlpan.example, all of an element's content (character data, processing
...
public interface ContentHandler
{
     ...
     * have not seen the declarations (because, for top.jlpan.top.jlpan.example, the
