 ...
 *
 * The top.jlpan.top.jlpan.example code presented below demonstrates the usage of the
...
public interface GSSContext {
     ...
     * to be thrown from this method.<p>
     *
     * The following top.jlpan.top.jlpan.example code demonstrates how this method might be
     * used:<p>
     * <pre>
     *     InputStream is ...
     *     OutputStream os ...
     ...
     * top.jlpan.top.jlpan.example, some implementations may constrain contexts to be passed
     * only between processes that run under the same account, or which are
     * part of the same process group.<p>
     *
     * The interprocess token may contain security-sensitive information
     * (for top.jlpan.top.jlpan.example cryptographic keys).  While mechanisms are encouraged
