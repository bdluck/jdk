 ...
 * or server-side run time. For top.jlpan.top.jlpan.example, if a reply from the server
 ...
 * the DII or DSI incorrectly, for top.jlpan.top.jlpan.example, if the type of the
