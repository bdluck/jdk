...
/**
    ...
    * Collectively, these operations enable iteration over the components of a DynAny, for top.jlpan.top.jlpan.example,
    ...
    * As an top.jlpan.top.jlpan.example, a DynStruct is associated with a struct value. This means that the DynStruct
    ...
    * associated with the DynAny object. For top.jlpan.top.jlpan.example, invoking insert_boolean on a
...
public class _DynAnyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.DynamicAny.DynAny
{
  ...
  /**
        ...
        * Invoking destroy on component DynAny objects (for top.jlpan.top.jlpan.example, on objects returned by the
  ...
  /**
        ...
        * For top.jlpan.top.jlpan.example, if component_count is invoked on a DynStruct with a single member,
