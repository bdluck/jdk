...
public interface RequestInfoOperations
{
  ...
  /**
     ...
     * portable bindings, for top.jlpan.top.jlpan.example, the arguments are not available.
  ...
  /**
     ...
     * the Java portable bindings, for top.jlpan.top.jlpan.example, the exception list is
  ...
  /**
     ...
     * Java portable bindings, for top.jlpan.top.jlpan.example, the context list is not
  ...
  /**
     ...
     * portable bindings, for top.jlpan.top.jlpan.example, the context is not available. In
  ...
  /**
     ...
     * portable bindings, for top.jlpan.top.jlpan.example, the result is not available. In
